...
# Unit tests for OpenapiClient::PaymentLinksApi
...
describe 'PaymentLinksApi' do
  ...
  describe 'test an instance of PaymentLinksApi' do
    it 'should create an instance of PaymentLinksApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::PaymentLinksApi)
    end
  end

  # unit tests for create_a_payment_link_session
  # Create a Payment Link
  # Create a Payment Link and pass through all the payment information, like the amount, currency, country and reference. 
  # @param payment_links_request 
  # @param [Hash] opts the optional parameters
  # @return [PaymentLinksResponse]
  describe 'create_a_payment_link_session test' do
    it 'should work' do
