...
# Unit tests for OpenapiClient::InstrumentsApi
...
describe 'InstrumentsApi' do
  ...
  describe 'test an instance of InstrumentsApi' do
    it 'should create an instance of InstrumentsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::InstrumentsApi)
    end
  end

  # unit tests for create_an_instrument
  ...
  # @param instrument_request 
  # @param [Hash] opts the optional parameters
  # @return [InstrumentResponse]
  describe 'create_an_instrument test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_instrument_details
  # Get instrument details
  # Returns details of an instrument
  # @param id The instrument id
  # @param [Hash] opts the optional parameters
  # @return [RetrieveInstrumentResponse]
  describe 'get_instrument_details test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_instrument_details
  # Update instrument details
  # Update details of an instrument
  # @param id The instrument ID
  # @param update_instrument_request 
  # @param [Hash] opts the optional parameters
  # @return [UpdateInstrumentResponse]
  describe 'update_instrument_details test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
