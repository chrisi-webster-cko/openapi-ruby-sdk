...
# Unit tests for OpenapiClient::PaymentRequestMultibancoSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestMultibancoSource do
  let(:instance) { OpenapiClient::PaymentRequestMultibancoSource.new }

  describe 'test an instance of PaymentRequestMultibancoSource' do
    it 'should create an instance of PaymentRequestMultibancoSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestMultibancoSource)
    end
  end
