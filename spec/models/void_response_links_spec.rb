...
# Unit tests for OpenapiClient::VoidResponseLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::VoidResponseLinks do
  let(:instance) { OpenapiClient::VoidResponseLinks.new }

  describe 'test an instance of VoidResponseLinks' do
    it 'should create an instance of VoidResponseLinks' do
      expect(instance).to be_instance_of(OpenapiClient::VoidResponseLinks)
    end
  end
