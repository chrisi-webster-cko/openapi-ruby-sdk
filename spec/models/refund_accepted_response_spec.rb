...
# Unit tests for OpenapiClient::RefundAcceptedResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::RefundAcceptedResponse do
  let(:instance) { OpenapiClient::RefundAcceptedResponse.new }

  describe 'test an instance of RefundAcceptedResponse' do
    it 'should create an instance of RefundAcceptedResponse' do
      expect(instance).to be_instance_of(OpenapiClient::RefundAcceptedResponse)
    end
  end
