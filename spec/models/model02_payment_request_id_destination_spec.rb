...
# Unit tests for OpenapiClient::Model02PaymentRequestIdDestination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model02PaymentRequestIdDestination do
  let(:instance) { OpenapiClient::Model02PaymentRequestIdDestination.new }

  describe 'test an instance of Model02PaymentRequestIdDestination' do
    it 'should create an instance of Model02PaymentRequestIdDestination' do
      expect(instance).to be_instance_of(OpenapiClient::Model02PaymentRequestIdDestination)
    end
  end
