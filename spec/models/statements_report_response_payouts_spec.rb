...
# Unit tests for OpenapiClient::StatementsReportResponsePayouts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::StatementsReportResponsePayouts do
  let(:instance) { OpenapiClient::StatementsReportResponsePayouts.new }

  describe 'test an instance of StatementsReportResponsePayouts' do
    it 'should create an instance of StatementsReportResponsePayouts' do
      expect(instance).to be_instance_of(OpenapiClient::StatementsReportResponsePayouts)
    end
  end
  ...
  describe 'test attribute "carried_forward_amount"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "current_period_amount"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "payout__fee"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
