...
# Unit tests for OpenapiClient::SourceLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SourceLinks do
  let(:instance) { OpenapiClient::SourceLinks.new }

  describe 'test an instance of SourceLinks' do
    it 'should create an instance of SourceLinks' do
      expect(instance).to be_instance_of(OpenapiClient::SourceLinks)
    end
  end
