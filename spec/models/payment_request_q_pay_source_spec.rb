...
# Unit tests for OpenapiClient::PaymentRequestQPaySource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestQPaySource do
  let(:instance) { OpenapiClient::PaymentRequestQPaySource.new }

  describe 'test an instance of PaymentRequestQPaySource' do
    it 'should create an instance of PaymentRequestQPaySource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestQPaySource)
    end
  end
