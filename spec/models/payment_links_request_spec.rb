...
# Unit tests for OpenapiClient::PaymentLinksRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentLinksRequest do
  let(:instance) { OpenapiClient::PaymentLinksRequest.new }

  describe 'test an instance of PaymentLinksRequest' do
    it 'should create an instance of PaymentLinksRequest' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentLinksRequest)
    end
  end
