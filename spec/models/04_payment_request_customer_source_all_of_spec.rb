...
# Unit tests for OpenapiClient::04PaymentRequestCustomerSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::04PaymentRequestCustomerSourceAllOf do
  let(:instance) { OpenapiClient::04PaymentRequestCustomerSourceAllOf.new }

  describe 'test an instance of 04PaymentRequestCustomerSourceAllOf' do
    it 'should create an instance of 04PaymentRequestCustomerSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::04PaymentRequestCustomerSourceAllOf)
    end
  end
