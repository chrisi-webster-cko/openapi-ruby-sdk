...
# Unit tests for OpenapiClient::VoidResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::VoidResponse do
  let(:instance) { OpenapiClient::VoidResponse.new }

  describe 'test an instance of VoidResponse' do
    it 'should create an instance of VoidResponse' do
      expect(instance).to be_instance_of(OpenapiClient::VoidResponse)
    end
  end
