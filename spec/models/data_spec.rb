...
describe OpenapiClient::Data do
  let(:instance) { OpenapiClient::Data.new }

  describe 'test an instance of Data' do
    it 'should create an instance of Data' do
      expect(instance).to be_instance_of(OpenapiClient::Data)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Pending", "Authorized", "Voided", "Partially Captured", "Captured", "Partially Refunded", "Refunded", "Declined", "Cancelled"])
