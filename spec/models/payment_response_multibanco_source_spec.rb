...
# Unit tests for OpenapiClient::PaymentResponseMultibancoSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseMultibancoSource do
  let(:instance) { OpenapiClient::PaymentResponseMultibancoSource.new }

  describe 'test an instance of PaymentResponseMultibancoSource' do
    it 'should create an instance of PaymentResponseMultibancoSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseMultibancoSource)
    end
  end
