...
# Unit tests for OpenapiClient::PaymentDestination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentDestination do
  let(:instance) { OpenapiClient::PaymentDestination.new }

  describe 'test an instance of PaymentDestination' do
    it 'should create an instance of PaymentDestination' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentDestination)
    end
  end
