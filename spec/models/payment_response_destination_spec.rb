...
# Unit tests for OpenapiClient::PaymentResponseDestination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseDestination do
  let(:instance) { OpenapiClient::PaymentResponseDestination.new }

  describe 'test an instance of PaymentResponseDestination' do
    it 'should create an instance of PaymentResponseDestination' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseDestination)
    end
  end
