...
# Unit tests for OpenapiClient::02AchSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::02AchSourceAllOf do
  let(:instance) { OpenapiClient::02AchSourceAllOf.new }

  describe 'test an instance of 02AchSourceAllOf' do
    it 'should create an instance of 02AchSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::02AchSourceAllOf)
    end
  end
