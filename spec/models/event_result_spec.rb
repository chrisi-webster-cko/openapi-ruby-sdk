...
# Unit tests for OpenapiClient::EventResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EventResult do
  let(:instance) { OpenapiClient::EventResult.new }

  describe 'test an instance of EventResult' do
    it 'should create an instance of EventResult' do
      expect(instance).to be_instance_of(OpenapiClient::EventResult)
    end
  end
