...
# Unit tests for OpenapiClient::PaymentResponseSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseSource do
  let(:instance) { OpenapiClient::PaymentResponseSource.new }

  describe 'test an instance of PaymentResponseSource' do
    it 'should create an instance of PaymentResponseSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseSource)
    end
  end
