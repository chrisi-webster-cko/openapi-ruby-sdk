...
# Unit tests for OpenapiClient::VoidAcceptedResponseLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::VoidAcceptedResponseLinks do
  let(:instance) { OpenapiClient::VoidAcceptedResponseLinks.new }

  describe 'test an instance of VoidAcceptedResponseLinks' do
    it 'should create an instance of VoidAcceptedResponseLinks' do
      expect(instance).to be_instance_of(OpenapiClient::VoidAcceptedResponseLinks)
    end
  end
