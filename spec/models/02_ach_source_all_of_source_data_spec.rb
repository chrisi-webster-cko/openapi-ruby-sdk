...
# Unit tests for OpenapiClient::02AchSourceAllOfSourceData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::02AchSourceAllOfSourceData do
  let(:instance) { OpenapiClient::02AchSourceAllOfSourceData.new }

  describe 'test an instance of 02AchSourceAllOfSourceData' do
    it 'should create an instance of 02AchSourceAllOfSourceData' do
      expect(instance).to be_instance_of(OpenapiClient::02AchSourceAllOfSourceData)
    end
  end
  describe 'test attribute "account_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Checking", "Savings", "Corporate", "CorpSavings"])
