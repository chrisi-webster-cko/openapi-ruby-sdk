...
# Unit tests for OpenapiClient::Model01SepaAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model01SepaAddress do
  let(:instance) { OpenapiClient::Model01SepaAddress.new }

  describe 'test an instance of Model01SepaAddress' do
    it 'should create an instance of Model01SepaAddress' do
      expect(instance).to be_instance_of(OpenapiClient::Model01SepaAddress)
    end
  end
