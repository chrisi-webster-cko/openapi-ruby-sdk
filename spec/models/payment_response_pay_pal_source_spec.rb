...
# Unit tests for OpenapiClient::PaymentResponsePayPalSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponsePayPalSource do
  let(:instance) { OpenapiClient::PaymentResponsePayPalSource.new }

  describe 'test an instance of PaymentResponsePayPalSource' do
    it 'should create an instance of PaymentResponsePayPalSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponsePayPalSource)
    end
  end
end
