...
# Unit tests for OpenapiClient::PaymentsReportResponseLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentsReportResponseLinks do
  let(:instance) { OpenapiClient::PaymentsReportResponseLinks.new }

  describe 'test an instance of PaymentsReportResponseLinks' do
    it 'should create an instance of PaymentsReportResponseLinks' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentsReportResponseLinks)
    end
  end
