...
# Unit tests for OpenapiClient::PaymentResponsePoliSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponsePoliSource do
  let(:instance) { OpenapiClient::PaymentResponsePoliSource.new }

  describe 'test an instance of PaymentResponsePoliSource' do
    it 'should create an instance of PaymentResponsePoliSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponsePoliSource)
    end
  end
end
