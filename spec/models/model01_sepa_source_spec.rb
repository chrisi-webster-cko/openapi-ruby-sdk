...
# Unit tests for OpenapiClient::Model01SepaSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model01SepaSource do
  let(:instance) { OpenapiClient::Model01SepaSource.new }

  describe 'test an instance of Model01SepaSource' do
    it 'should create an instance of Model01SepaSource' do
      expect(instance).to be_instance_of(OpenapiClient::Model01SepaSource)
    end
  end
