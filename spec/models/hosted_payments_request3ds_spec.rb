...
# Unit tests for OpenapiClient::HostedPaymentsRequest3ds
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::HostedPaymentsRequest3ds do
  let(:instance) { OpenapiClient::HostedPaymentsRequest3ds.new }

  describe 'test an instance of HostedPaymentsRequest3ds' do
    it 'should create an instance of HostedPaymentsRequest3ds' do
      expect(instance).to be_instance_of(OpenapiClient::HostedPaymentsRequest3ds)
    end
  end
