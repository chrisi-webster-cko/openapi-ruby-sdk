...
# Unit tests for OpenapiClient::SubmitBatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SubmitBatchRequest do
  let(:instance) { OpenapiClient::SubmitBatchRequest.new }

  describe 'test an instance of SubmitBatchRequest' do
    it 'should create an instance of SubmitBatchRequest' do
      expect(instance).to be_instance_of(OpenapiClient::SubmitBatchRequest)
    end
  end
