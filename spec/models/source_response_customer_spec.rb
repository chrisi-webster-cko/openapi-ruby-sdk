...
# Unit tests for OpenapiClient::SourceResponseCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SourceResponseCustomer do
  let(:instance) { OpenapiClient::SourceResponseCustomer.new }

  describe 'test an instance of SourceResponseCustomer' do
    it 'should create an instance of SourceResponseCustomer' do
      expect(instance).to be_instance_of(OpenapiClient::SourceResponseCustomer)
    end
  end
