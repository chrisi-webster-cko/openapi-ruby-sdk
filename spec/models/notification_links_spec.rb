...
# Unit tests for OpenapiClient::NotificationLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::NotificationLinks do
  let(:instance) { OpenapiClient::NotificationLinks.new }

  describe 'test an instance of NotificationLinks' do
    it 'should create an instance of NotificationLinks' do
      expect(instance).to be_instance_of(OpenapiClient::NotificationLinks)
    end
  end
