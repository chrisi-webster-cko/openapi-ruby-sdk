...
# Unit tests for OpenapiClient::PaymentRequestP24SourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestP24SourceAllOf do
  let(:instance) { OpenapiClient::PaymentRequestP24SourceAllOf.new }

  describe 'test an instance of PaymentRequestP24SourceAllOf' do
    it 'should create an instance of PaymentRequestP24SourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestP24SourceAllOf)
    end
  end
  describe 'test attribute "payment_country"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["PL"])
  ...
  describe 'test attribute "account_holder_email"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
