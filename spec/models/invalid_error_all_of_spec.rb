...
# Unit tests for OpenapiClient::InvalidErrorAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::InvalidErrorAllOf do
  let(:instance) { OpenapiClient::InvalidErrorAllOf.new }

  describe 'test an instance of InvalidErrorAllOf' do
    it 'should create an instance of InvalidErrorAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::InvalidErrorAllOf)
    end
  end
