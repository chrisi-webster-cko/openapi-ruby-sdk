...
# Unit tests for OpenapiClient::PaymentRequestProcessingDlocalPayer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestProcessingDlocalPayer do
  let(:instance) { OpenapiClient::PaymentRequestProcessingDlocalPayer.new }

  describe 'test an instance of PaymentRequestProcessingDlocalPayer' do
    it 'should create an instance of PaymentRequestProcessingDlocalPayer' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestProcessingDlocalPayer)
    end
  end
