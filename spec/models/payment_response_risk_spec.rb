...
# Unit tests for OpenapiClient::PaymentResponseRisk
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseRisk do
  let(:instance) { OpenapiClient::PaymentResponseRisk.new }

  describe 'test an instance of PaymentResponseRisk' do
    it 'should create an instance of PaymentResponseRisk' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseRisk)
    end
  end
