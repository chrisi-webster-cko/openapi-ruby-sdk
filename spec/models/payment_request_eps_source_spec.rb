...
# Unit tests for OpenapiClient::PaymentRequestEpsSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestEpsSource do
  let(:instance) { OpenapiClient::PaymentRequestEpsSource.new }

  describe 'test an instance of PaymentRequestEpsSource' do
    it 'should create an instance of PaymentRequestEpsSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestEpsSource)
    end
  end
