...
# Unit tests for OpenapiClient::DisputeSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DisputeSummary do
  let(:instance) { OpenapiClient::DisputeSummary.new }

  describe 'test an instance of DisputeSummary' do
    it 'should create an instance of DisputeSummary' do
      expect(instance).to be_instance_of(OpenapiClient::DisputeSummary)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["received", "evidence_required", "evidence_under_review", "resolved", "closed", "won", "lost", "canceled", "accepted"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "payment_arn"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
