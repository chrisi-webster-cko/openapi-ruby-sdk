...
# Unit tests for OpenapiClient::StatementsReportResponseLinksPayments
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::StatementsReportResponseLinksPayments do
  let(:instance) { OpenapiClient::StatementsReportResponseLinksPayments.new }

  describe 'test an instance of StatementsReportResponseLinksPayments' do
    it 'should create an instance of StatementsReportResponseLinksPayments' do
      expect(instance).to be_instance_of(OpenapiClient::StatementsReportResponseLinksPayments)
    end
  end
