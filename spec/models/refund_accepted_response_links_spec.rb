...
# Unit tests for OpenapiClient::RefundAcceptedResponseLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::RefundAcceptedResponseLinks do
  let(:instance) { OpenapiClient::RefundAcceptedResponseLinks.new }

  describe 'test an instance of RefundAcceptedResponseLinks' do
    it 'should create an instance of RefundAcceptedResponseLinks' do
      expect(instance).to be_instance_of(OpenapiClient::RefundAcceptedResponseLinks)
    end
  end
