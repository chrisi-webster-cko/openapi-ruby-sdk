...
# Unit tests for OpenapiClient::DisputePayment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DisputePayment do
  let(:instance) { OpenapiClient::DisputePayment.new }

  describe 'test an instance of DisputePayment' do
    it 'should create an instance of DisputePayment' do
      expect(instance).to be_instance_of(OpenapiClient::DisputePayment)
    end
  end
