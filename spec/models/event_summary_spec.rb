...
# Unit tests for OpenapiClient::EventSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EventSummary do
  let(:instance) { OpenapiClient::EventSummary.new }

  describe 'test an instance of EventSummary' do
    it 'should create an instance of EventSummary' do
      expect(instance).to be_instance_of(OpenapiClient::EventSummary)
    end
  end
