...
# Unit tests for OpenapiClient::PaymentsReportResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentsReportResponseData do
  let(:instance) { OpenapiClient::PaymentsReportResponseData.new }

  describe 'test an instance of PaymentsReportResponseData' do
    it 'should create an instance of PaymentsReportResponseData' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentsReportResponseData)
    end
  end
  ...
  describe 'test attribute "processing_currency"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
