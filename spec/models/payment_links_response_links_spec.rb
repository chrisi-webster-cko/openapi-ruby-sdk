...
# Unit tests for OpenapiClient::PaymentLinksResponseLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentLinksResponseLinks do
  let(:instance) { OpenapiClient::PaymentLinksResponseLinks.new }

  describe 'test an instance of PaymentLinksResponseLinks' do
    it 'should create an instance of PaymentLinksResponseLinks' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentLinksResponseLinks)
    end
  end
