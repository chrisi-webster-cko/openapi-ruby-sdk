...
# Unit tests for OpenapiClient::01PaymentRequestTokenSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::01PaymentRequestTokenSourceAllOf do
  let(:instance) { OpenapiClient::01PaymentRequestTokenSourceAllOf.new }

  describe 'test an instance of 01PaymentRequestTokenSourceAllOf' do
    it 'should create an instance of 01PaymentRequestTokenSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::01PaymentRequestTokenSourceAllOf)
    end
  end
