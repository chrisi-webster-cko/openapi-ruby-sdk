...
# Unit tests for OpenapiClient::Model03PaymentRequestCardSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model03PaymentRequestCardSource do
  let(:instance) { OpenapiClient::Model03PaymentRequestCardSource.new }

  describe 'test an instance of Model03PaymentRequestCardSource' do
    it 'should create an instance of Model03PaymentRequestCardSource' do
      expect(instance).to be_instance_of(OpenapiClient::Model03PaymentRequestCardSource)
    end
  end
