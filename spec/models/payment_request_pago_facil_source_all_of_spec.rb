...
# Unit tests for OpenapiClient::PaymentRequestPagoFacilSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestPagoFacilSourceAllOf do
  let(:instance) { OpenapiClient::PaymentRequestPagoFacilSourceAllOf.new }

  describe 'test an instance of PaymentRequestPagoFacilSourceAllOf' do
    it 'should create an instance of PaymentRequestPagoFacilSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestPagoFacilSourceAllOf)
    end
  end
  ...
  describe 'test attribute "country"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["AR"])
      # validator.allowable_values.each do |value|
