...
# Unit tests for OpenapiClient::UpdateInstrumentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateInstrumentResponse do
  let(:instance) { OpenapiClient::UpdateInstrumentResponse.new }

  describe 'test an instance of UpdateInstrumentResponse' do
    it 'should create an instance of UpdateInstrumentResponse' do
      expect(instance).to be_instance_of(OpenapiClient::UpdateInstrumentResponse)
    end
  end
