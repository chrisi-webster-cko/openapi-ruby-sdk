...
# Unit tests for OpenapiClient::RetrieveInstrumentResponseCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::RetrieveInstrumentResponseCustomer do
  let(:instance) { OpenapiClient::RetrieveInstrumentResponseCustomer.new }

  describe 'test an instance of RetrieveInstrumentResponseCustomer' do
    it 'should create an instance of RetrieveInstrumentResponseCustomer' do
      expect(instance).to be_instance_of(OpenapiClient::RetrieveInstrumentResponseCustomer)
    end
  end
