...
# Unit tests for OpenapiClient::PaymentRequestProcessing
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestProcessing do
  let(:instance) { OpenapiClient::PaymentRequestProcessing.new }

  describe 'test an instance of PaymentRequestProcessing' do
    it 'should create an instance of PaymentRequestProcessing' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestProcessing)
    end
  end
  describe 'test attribute "aft"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "dlocal"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
