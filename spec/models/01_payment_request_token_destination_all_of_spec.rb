...
# Unit tests for OpenapiClient::01PaymentRequestTokenDestinationAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::01PaymentRequestTokenDestinationAllOf do
  let(:instance) { OpenapiClient::01PaymentRequestTokenDestinationAllOf.new }

  describe 'test an instance of 01PaymentRequestTokenDestinationAllOf' do
    it 'should create an instance of 01PaymentRequestTokenDestinationAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::01PaymentRequestTokenDestinationAllOf)
    end
  end
