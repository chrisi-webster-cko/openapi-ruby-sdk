...
# Unit tests for OpenapiClient::PaymentRequestGiropaySourceAllOfInfoFields
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestGiropaySourceAllOfInfoFields do
  let(:instance) { OpenapiClient::PaymentRequestGiropaySourceAllOfInfoFields.new }

  describe 'test an instance of PaymentRequestGiropaySourceAllOfInfoFields' do
    it 'should create an instance of PaymentRequestGiropaySourceAllOfInfoFields' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestGiropaySourceAllOfInfoFields)
    end
  end
