...
# Unit tests for OpenapiClient::FileUploadResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::FileUploadResponse do
  let(:instance) { OpenapiClient::FileUploadResponse.new }

  describe 'test an instance of FileUploadResponse' do
    it 'should create an instance of FileUploadResponse' do
      expect(instance).to be_instance_of(OpenapiClient::FileUploadResponse)
    end
  end
