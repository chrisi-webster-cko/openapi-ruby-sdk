...
# Unit tests for OpenapiClient::PaymentRequestIdealSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestIdealSourceAllOf do
  let(:instance) { OpenapiClient::PaymentRequestIdealSourceAllOf.new }

  describe 'test an instance of PaymentRequestIdealSourceAllOf' do
    it 'should create an instance of PaymentRequestIdealSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestIdealSourceAllOf)
    end
  end
