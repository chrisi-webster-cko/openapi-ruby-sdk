...
# Unit tests for OpenapiClient::03CardTokenRequestAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::03CardTokenRequestAllOf do
  let(:instance) { OpenapiClient::03CardTokenRequestAllOf.new }

  describe 'test an instance of 03CardTokenRequestAllOf' do
    it 'should create an instance of 03CardTokenRequestAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::03CardTokenRequestAllOf)
    end
  end
