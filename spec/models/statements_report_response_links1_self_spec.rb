...
# Unit tests for OpenapiClient::StatementsReportResponseLinks1Self
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::StatementsReportResponseLinks1Self do
  let(:instance) { OpenapiClient::StatementsReportResponseLinks1Self.new }

  describe 'test an instance of StatementsReportResponseLinks1Self' do
    it 'should create an instance of StatementsReportResponseLinks1Self' do
      expect(instance).to be_instance_of(OpenapiClient::StatementsReportResponseLinks1Self)
    end
  end
