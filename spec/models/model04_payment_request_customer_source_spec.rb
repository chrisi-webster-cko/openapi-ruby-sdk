...
# Unit tests for OpenapiClient::Model04PaymentRequestCustomerSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model04PaymentRequestCustomerSource do
  let(:instance) { OpenapiClient::Model04PaymentRequestCustomerSource.new }

  describe 'test an instance of Model04PaymentRequestCustomerSource' do
    it 'should create an instance of Model04PaymentRequestCustomerSource' do
      expect(instance).to be_instance_of(OpenapiClient::Model04PaymentRequestCustomerSource)
    end
  end
