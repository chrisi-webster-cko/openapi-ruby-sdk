...
# Unit tests for OpenapiClient::PaymentShipping
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentShipping do
  let(:instance) { OpenapiClient::PaymentShipping.new }

  describe 'test an instance of PaymentShipping' do
    it 'should create an instance of PaymentShipping' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentShipping)
    end
  end
