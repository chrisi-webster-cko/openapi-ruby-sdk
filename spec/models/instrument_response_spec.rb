...
# Unit tests for OpenapiClient::InstrumentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::InstrumentResponse do
  let(:instance) { OpenapiClient::InstrumentResponse.new }

  describe 'test an instance of InstrumentResponse' do
    it 'should create an instance of InstrumentResponse' do
      expect(instance).to be_instance_of(OpenapiClient::InstrumentResponse)
    end
  end
