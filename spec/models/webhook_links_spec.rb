...
# Unit tests for OpenapiClient::WebhookLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WebhookLinks do
  let(:instance) { OpenapiClient::WebhookLinks.new }

  describe 'test an instance of WebhookLinks' do
    it 'should create an instance of WebhookLinks' do
      expect(instance).to be_instance_of(OpenapiClient::WebhookLinks)
    end
  end
