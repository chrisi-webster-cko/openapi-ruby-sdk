...
# Unit tests for OpenapiClient::PaymentRequestGiropaySourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestGiropaySourceAllOf do
  let(:instance) { OpenapiClient::PaymentRequestGiropaySourceAllOf.new }

  describe 'test an instance of PaymentRequestGiropaySourceAllOf' do
    it 'should create an instance of PaymentRequestGiropaySourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestGiropaySourceAllOf)
    end
  end
  ...
  describe 'test attribute "info_fields"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
