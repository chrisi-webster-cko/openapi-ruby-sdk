...
# Unit tests for OpenapiClient::PaymentResponseIdealSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseIdealSource do
  let(:instance) { OpenapiClient::PaymentResponseIdealSource.new }

  describe 'test an instance of PaymentResponseIdealSource' do
    it 'should create an instance of PaymentResponseIdealSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseIdealSource)
    end
  end
