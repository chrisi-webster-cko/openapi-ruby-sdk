...
# Unit tests for OpenapiClient::PaymentLinksResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentLinksResponse do
  let(:instance) { OpenapiClient::PaymentLinksResponse.new }

  describe 'test an instance of PaymentLinksResponse' do
    it 'should create an instance of PaymentLinksResponse' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentLinksResponse)
    end
  end
