...
# Unit tests for OpenapiClient::Model02GooglePayTokenResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model02GooglePayTokenResponse do
  let(:instance) { OpenapiClient::Model02GooglePayTokenResponse.new }

  describe 'test an instance of Model02GooglePayTokenResponse' do
    it 'should create an instance of Model02GooglePayTokenResponse' do
      expect(instance).to be_instance_of(OpenapiClient::Model02GooglePayTokenResponse)
    end
  end
end
