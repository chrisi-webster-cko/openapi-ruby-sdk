...
# Unit tests for OpenapiClient::05PaymentRequestNetworkTokenSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::05PaymentRequestNetworkTokenSourceAllOf do
  let(:instance) { OpenapiClient::05PaymentRequestNetworkTokenSourceAllOf.new }

  describe 'test an instance of 05PaymentRequestNetworkTokenSourceAllOf' do
    it 'should create an instance of 05PaymentRequestNetworkTokenSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::05PaymentRequestNetworkTokenSourceAllOf)
    end
  end
