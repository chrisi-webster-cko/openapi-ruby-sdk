...
# Unit tests for OpenapiClient::PaymentResponseRapiPagoSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseRapiPagoSource do
  let(:instance) { OpenapiClient::PaymentResponseRapiPagoSource.new }

  describe 'test an instance of PaymentResponseRapiPagoSource' do
    it 'should create an instance of PaymentResponseRapiPagoSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseRapiPagoSource)
    end
  end
