...
# Unit tests for OpenapiClient::PaymentRequestQPaySourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestQPaySourceAllOf do
  let(:instance) { OpenapiClient::PaymentRequestQPaySourceAllOf.new }

  describe 'test an instance of PaymentRequestQPaySourceAllOf' do
    it 'should create an instance of PaymentRequestQPaySourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestQPaySourceAllOf)
    end
  end
