...
# Unit tests for OpenapiClient::EventObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EventObject do
  let(:instance) { OpenapiClient::EventObject.new }

  describe 'test an instance of EventObject' do
    it 'should create an instance of EventObject' do
      expect(instance).to be_instance_of(OpenapiClient::EventObject)
    end
  end
