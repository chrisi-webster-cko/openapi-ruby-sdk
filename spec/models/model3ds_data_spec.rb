...
# Unit tests for OpenapiClient::Model3dsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model3dsData do
  let(:instance) { OpenapiClient::Model3dsData.new }

  describe 'test an instance of Model3dsData' do
    it 'should create an instance of Model3dsData' do
      expect(instance).to be_instance_of(OpenapiClient::Model3dsData)
    end
  end
  describe 'test attribute "downgraded"' do
    it 'should work' do
  ...
  describe 'test attribute "signature_valid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
