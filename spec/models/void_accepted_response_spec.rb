...
# Unit tests for OpenapiClient::VoidAcceptedResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::VoidAcceptedResponse do
  let(:instance) { OpenapiClient::VoidAcceptedResponse.new }

  describe 'test an instance of VoidAcceptedResponse' do
    it 'should create an instance of VoidAcceptedResponse' do
      expect(instance).to be_instance_of(OpenapiClient::VoidAcceptedResponse)
    end
  end
