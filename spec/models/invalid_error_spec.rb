...
# Unit tests for OpenapiClient::InvalidError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::InvalidError do
  let(:instance) { OpenapiClient::InvalidError.new }

  describe 'test an instance of InvalidError' do
    it 'should create an instance of InvalidError' do
      expect(instance).to be_instance_of(OpenapiClient::InvalidError)
    end
  end
