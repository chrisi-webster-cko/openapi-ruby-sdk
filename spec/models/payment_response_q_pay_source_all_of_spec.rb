...
# Unit tests for OpenapiClient::PaymentResponseQPaySourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseQPaySourceAllOf do
  let(:instance) { OpenapiClient::PaymentResponseQPaySourceAllOf.new }

  describe 'test an instance of PaymentResponseQPaySourceAllOf' do
    it 'should create an instance of PaymentResponseQPaySourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseQPaySourceAllOf)
    end
  end
  ...
  describe 'test attribute "qpay_status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
