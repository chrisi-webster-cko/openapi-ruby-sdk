...
# Unit tests for OpenapiClient::03CardTokenResponseAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::03CardTokenResponseAllOf do
  let(:instance) { OpenapiClient::03CardTokenResponseAllOf.new }

  describe 'test an instance of 03CardTokenResponseAllOf' do
    it 'should create an instance of 03CardTokenResponseAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::03CardTokenResponseAllOf)
    end
  end
