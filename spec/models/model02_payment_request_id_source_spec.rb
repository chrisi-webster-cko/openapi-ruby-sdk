...
# Unit tests for OpenapiClient::Model02PaymentRequestIdSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model02PaymentRequestIdSource do
  let(:instance) { OpenapiClient::Model02PaymentRequestIdSource.new }

  describe 'test an instance of Model02PaymentRequestIdSource' do
    it 'should create an instance of Model02PaymentRequestIdSource' do
      expect(instance).to be_instance_of(OpenapiClient::Model02PaymentRequestIdSource)
    end
  end
