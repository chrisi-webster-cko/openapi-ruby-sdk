...
# Unit tests for OpenapiClient::01SepaSourceResponseAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::01SepaSourceResponseAllOf do
  let(:instance) { OpenapiClient::01SepaSourceResponseAllOf.new }

  describe 'test an instance of 01SepaSourceResponseAllOf' do
    it 'should create an instance of 01SepaSourceResponseAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::01SepaSourceResponseAllOf)
    end
  end
