...
# Unit tests for OpenapiClient::Model01ApplePayTokenResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model01ApplePayTokenResponse do
  let(:instance) { OpenapiClient::Model01ApplePayTokenResponse.new }

  describe 'test an instance of Model01ApplePayTokenResponse' do
    it 'should create an instance of Model01ApplePayTokenResponse' do
      expect(instance).to be_instance_of(OpenapiClient::Model01ApplePayTokenResponse)
    end
  end
end
