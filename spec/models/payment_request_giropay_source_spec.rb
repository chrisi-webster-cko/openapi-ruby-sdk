...
# Unit tests for OpenapiClient::PaymentRequestGiropaySource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestGiropaySource do
  let(:instance) { OpenapiClient::PaymentRequestGiropaySource.new }

  describe 'test an instance of PaymentRequestGiropaySource' do
    it 'should create an instance of PaymentRequestGiropaySource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestGiropaySource)
    end
  end
