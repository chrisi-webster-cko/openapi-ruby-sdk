...
# Unit tests for OpenapiClient::Model01SepaSourceResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model01SepaSourceResponse do
  let(:instance) { OpenapiClient::Model01SepaSourceResponse.new }

  describe 'test an instance of Model01SepaSourceResponse' do
    it 'should create an instance of Model01SepaSourceResponse' do
      expect(instance).to be_instance_of(OpenapiClient::Model01SepaSourceResponse)
    end
  end
