...
# Unit tests for OpenapiClient::PaymentsReportResponseLinks1Next
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentsReportResponseLinks1Next do
  let(:instance) { OpenapiClient::PaymentsReportResponseLinks1Next.new }

  describe 'test an instance of PaymentsReportResponseLinks1Next' do
    it 'should create an instance of PaymentsReportResponseLinks1Next' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentsReportResponseLinks1Next)
    end
  end
