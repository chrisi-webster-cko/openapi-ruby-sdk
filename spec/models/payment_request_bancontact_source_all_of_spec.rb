...
# Unit tests for OpenapiClient::PaymentRequestBancontactSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestBancontactSourceAllOf do
  let(:instance) { OpenapiClient::PaymentRequestBancontactSourceAllOf.new }

  describe 'test an instance of PaymentRequestBancontactSourceAllOf' do
    it 'should create an instance of PaymentRequestBancontactSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestBancontactSourceAllOf)
    end
  end
  describe 'test attribute "payment_country"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["BE"])
      # validator.allowable_values.each do |value|
      #   expect { instance.payment_country = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "billing_descriptor"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "language"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["fr", "nl", "de", "en"])
      # validator.allowable_values.each do |value|
