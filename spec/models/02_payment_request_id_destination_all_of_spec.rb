...
# Unit tests for OpenapiClient::02PaymentRequestIdDestinationAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::02PaymentRequestIdDestinationAllOf do
  let(:instance) { OpenapiClient::02PaymentRequestIdDestinationAllOf.new }

  describe 'test an instance of 02PaymentRequestIdDestinationAllOf' do
    it 'should create an instance of 02PaymentRequestIdDestinationAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::02PaymentRequestIdDestinationAllOf)
    end
  end
