...
# Unit tests for OpenapiClient::Model03CardTokenRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model03CardTokenRequest do
  let(:instance) { OpenapiClient::Model03CardTokenRequest.new }

  describe 'test an instance of Model03CardTokenRequest' do
    it 'should create an instance of Model03CardTokenRequest' do
      expect(instance).to be_instance_of(OpenapiClient::Model03CardTokenRequest)
    end
  end
