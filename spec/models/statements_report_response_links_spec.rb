...
# Unit tests for OpenapiClient::StatementsReportResponseLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::StatementsReportResponseLinks do
  let(:instance) { OpenapiClient::StatementsReportResponseLinks.new }

  describe 'test an instance of StatementsReportResponseLinks' do
    it 'should create an instance of StatementsReportResponseLinks' do
      expect(instance).to be_instance_of(OpenapiClient::StatementsReportResponseLinks)
    end
  end
