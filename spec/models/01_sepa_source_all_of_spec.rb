...
# Unit tests for OpenapiClient::01SepaSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::01SepaSourceAllOf do
  let(:instance) { OpenapiClient::01SepaSourceAllOf.new }

  describe 'test an instance of 01SepaSourceAllOf' do
    it 'should create an instance of 01SepaSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::01SepaSourceAllOf)
    end
  end
