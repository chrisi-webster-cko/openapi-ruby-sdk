...
# Unit tests for OpenapiClient::Model01ApplePayTokenRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model01ApplePayTokenRequest do
  let(:instance) { OpenapiClient::Model01ApplePayTokenRequest.new }

  describe 'test an instance of Model01ApplePayTokenRequest' do
    it 'should create an instance of Model01ApplePayTokenRequest' do
      expect(instance).to be_instance_of(OpenapiClient::Model01ApplePayTokenRequest)
    end
  end
