...
# Unit tests for OpenapiClient::PaymentsReportResponseBreakdown
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentsReportResponseBreakdown do
  let(:instance) { OpenapiClient::PaymentsReportResponseBreakdown.new }

  describe 'test an instance of PaymentsReportResponseBreakdown' do
    it 'should create an instance of PaymentsReportResponseBreakdown' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentsReportResponseBreakdown)
    end
  end
  ...
  describe 'test attribute "processing_currency_amount"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "payout_currency_amount"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
