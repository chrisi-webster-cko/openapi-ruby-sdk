...
# Unit tests for OpenapiClient::PaymentResponseBancontactSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseBancontactSource do
  let(:instance) { OpenapiClient::PaymentResponseBancontactSource.new }

  describe 'test an instance of PaymentResponseBancontactSource' do
    it 'should create an instance of PaymentResponseBancontactSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseBancontactSource)
    end
  end
