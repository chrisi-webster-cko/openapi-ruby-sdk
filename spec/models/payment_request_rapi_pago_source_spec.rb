...
# Unit tests for OpenapiClient::PaymentRequestRapiPagoSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestRapiPagoSource do
  let(:instance) { OpenapiClient::PaymentRequestRapiPagoSource.new }

  describe 'test an instance of PaymentRequestRapiPagoSource' do
    it 'should create an instance of PaymentRequestRapiPagoSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestRapiPagoSource)
    end
  end
