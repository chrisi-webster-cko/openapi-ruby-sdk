...
# Unit tests for OpenapiClient::PaymentRequestRapiPagoSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestRapiPagoSourceAllOf do
  let(:instance) { OpenapiClient::PaymentRequestRapiPagoSourceAllOf.new }

  describe 'test an instance of PaymentRequestRapiPagoSourceAllOf' do
    it 'should create an instance of PaymentRequestRapiPagoSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestRapiPagoSourceAllOf)
    end
  end
