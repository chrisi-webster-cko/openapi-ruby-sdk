...
# Unit tests for OpenapiClient::FileResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::FileResult do
  let(:instance) { OpenapiClient::FileResult.new }

  describe 'test an instance of FileResult' do
    it 'should create an instance of FileResult' do
      expect(instance).to be_instance_of(OpenapiClient::FileResult)
    end
  end
