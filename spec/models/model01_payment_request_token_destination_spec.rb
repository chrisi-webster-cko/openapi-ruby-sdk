...
# Unit tests for OpenapiClient::Model01PaymentRequestTokenDestination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model01PaymentRequestTokenDestination do
  let(:instance) { OpenapiClient::Model01PaymentRequestTokenDestination.new }

  describe 'test an instance of Model01PaymentRequestTokenDestination' do
    it 'should create an instance of Model01PaymentRequestTokenDestination' do
      expect(instance).to be_instance_of(OpenapiClient::Model01PaymentRequestTokenDestination)
    end
  end
