...
# Unit tests for OpenapiClient::PaymentResponseSofortSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseSofortSourceAllOf do
  let(:instance) { OpenapiClient::PaymentResponseSofortSourceAllOf.new }

  describe 'test an instance of PaymentResponseSofortSourceAllOf' do
    it 'should create an instance of PaymentResponseSofortSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseSofortSourceAllOf)
    end
  end
