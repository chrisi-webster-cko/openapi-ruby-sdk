...
# Unit tests for OpenapiClient::PaymentRequestBoletoSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestBoletoSource do
  let(:instance) { OpenapiClient::PaymentRequestBoletoSource.new }

  describe 'test an instance of PaymentRequestBoletoSource' do
    it 'should create an instance of PaymentRequestBoletoSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestBoletoSource)
    end
  end
