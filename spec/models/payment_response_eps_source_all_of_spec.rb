...
# Unit tests for OpenapiClient::PaymentResponseEpsSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseEpsSourceAllOf do
  let(:instance) { OpenapiClient::PaymentResponseEpsSourceAllOf.new }

  describe 'test an instance of PaymentResponseEpsSourceAllOf' do
    it 'should create an instance of PaymentResponseEpsSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseEpsSourceAllOf)
    end
  end
