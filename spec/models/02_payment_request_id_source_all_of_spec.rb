...
# Unit tests for OpenapiClient::02PaymentRequestIdSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::02PaymentRequestIdSourceAllOf do
  let(:instance) { OpenapiClient::02PaymentRequestIdSourceAllOf.new }

  describe 'test an instance of 02PaymentRequestIdSourceAllOf' do
    it 'should create an instance of 02PaymentRequestIdSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::02PaymentRequestIdSourceAllOf)
    end
  end
