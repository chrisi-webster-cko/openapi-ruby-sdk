...
# Unit tests for OpenapiClient::RetrieveInstrumentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::RetrieveInstrumentResponse do
  let(:instance) { OpenapiClient::RetrieveInstrumentResponse.new }

  describe 'test an instance of RetrieveInstrumentResponse' do
    it 'should create an instance of RetrieveInstrumentResponse' do
      expect(instance).to be_instance_of(OpenapiClient::RetrieveInstrumentResponse)
    end
  end
