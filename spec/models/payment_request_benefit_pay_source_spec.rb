...
# Unit tests for OpenapiClient::PaymentRequestBenefitPaySource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestBenefitPaySource do
  let(:instance) { OpenapiClient::PaymentRequestBenefitPaySource.new }

  describe 'test an instance of PaymentRequestBenefitPaySource' do
    it 'should create an instance of PaymentRequestBenefitPaySource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestBenefitPaySource)
    end
  end
