...
# Unit tests for OpenapiClient::PaymentResponseLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseLinks do
  let(:instance) { OpenapiClient::PaymentResponseLinks.new }

  describe 'test an instance of PaymentResponseLinks' do
    it 'should create an instance of PaymentResponseLinks' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseLinks)
    end
  end
