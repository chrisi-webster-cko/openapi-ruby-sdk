...
# Unit tests for OpenapiClient::PaymentResponseBenefitPaySourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseBenefitPaySourceAllOf do
  let(:instance) { OpenapiClient::PaymentResponseBenefitPaySourceAllOf.new }

  describe 'test an instance of PaymentResponseBenefitPaySourceAllOf' do
    it 'should create an instance of PaymentResponseBenefitPaySourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseBenefitPaySourceAllOf)
    end
  end
  ...
  describe 'test attribute "qr_data"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
