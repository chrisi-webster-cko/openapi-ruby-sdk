...
# Unit tests for OpenapiClient::01SepaSourceResponseAllOfResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::01SepaSourceResponseAllOfResponseData do
  let(:instance) { OpenapiClient::01SepaSourceResponseAllOfResponseData.new }

  describe 'test an instance of 01SepaSourceResponseAllOfResponseData' do
    it 'should create an instance of 01SepaSourceResponseAllOfResponseData' do
      expect(instance).to be_instance_of(OpenapiClient::01SepaSourceResponseAllOfResponseData)
    end
  end
