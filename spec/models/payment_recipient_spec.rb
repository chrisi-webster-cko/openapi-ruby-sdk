...
# Unit tests for OpenapiClient::PaymentRecipient
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRecipient do
  let(:instance) { OpenapiClient::PaymentRecipient.new }

  describe 'test an instance of PaymentRecipient' do
    it 'should create an instance of PaymentRecipient' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRecipient)
    end
  end
