...
# Unit tests for OpenapiClient::PaymentRequestPagoFacilSourceAllOfPayer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestPagoFacilSourceAllOfPayer do
  let(:instance) { OpenapiClient::PaymentRequestPagoFacilSourceAllOfPayer.new }

  describe 'test an instance of PaymentRequestPagoFacilSourceAllOfPayer' do
    it 'should create an instance of PaymentRequestPagoFacilSourceAllOfPayer' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestPagoFacilSourceAllOfPayer)
    end
  end
