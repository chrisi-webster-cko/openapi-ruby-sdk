...
# Unit tests for OpenapiClient::CaptureAcceptedResponseLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CaptureAcceptedResponseLinks do
  let(:instance) { OpenapiClient::CaptureAcceptedResponseLinks.new }

  describe 'test an instance of CaptureAcceptedResponseLinks' do
    it 'should create an instance of CaptureAcceptedResponseLinks' do
      expect(instance).to be_instance_of(OpenapiClient::CaptureAcceptedResponseLinks)
    end
  end
