...
# Unit tests for OpenapiClient::PaymentRequestBancontactSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestBancontactSource do
  let(:instance) { OpenapiClient::PaymentRequestBancontactSource.new }

  describe 'test an instance of PaymentRequestBancontactSource' do
    it 'should create an instance of PaymentRequestBancontactSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestBancontactSource)
    end
  end
