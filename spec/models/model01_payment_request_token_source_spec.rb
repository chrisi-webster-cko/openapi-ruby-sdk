...
# Unit tests for OpenapiClient::Model01PaymentRequestTokenSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model01PaymentRequestTokenSource do
  let(:instance) { OpenapiClient::Model01PaymentRequestTokenSource.new }

  describe 'test an instance of Model01PaymentRequestTokenSource' do
    it 'should create an instance of Model01PaymentRequestTokenSource' do
      expect(instance).to be_instance_of(OpenapiClient::Model01PaymentRequestTokenSource)
    end
  end
