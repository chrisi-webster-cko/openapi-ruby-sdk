...
# Unit tests for OpenapiClient::SourceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SourceRequest do
  let(:instance) { OpenapiClient::SourceRequest.new }

  describe 'test an instance of SourceRequest' do
    it 'should create an instance of SourceRequest' do
      expect(instance).to be_instance_of(OpenapiClient::SourceRequest)
    end
  end
