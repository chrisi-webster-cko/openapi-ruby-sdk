...
# Unit tests for OpenapiClient::PaymentResponseIdealSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseIdealSourceAllOf do
  let(:instance) { OpenapiClient::PaymentResponseIdealSourceAllOf.new }

  describe 'test an instance of PaymentResponseIdealSourceAllOf' do
    it 'should create an instance of PaymentResponseIdealSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseIdealSourceAllOf)
    end
  end
