...
# Unit tests for OpenapiClient::PaymentRequestSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestSource do
  let(:instance) { OpenapiClient::PaymentRequestSource.new }

  describe 'test an instance of PaymentRequestSource' do
    it 'should create an instance of PaymentRequestSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestSource)
    end
  end
