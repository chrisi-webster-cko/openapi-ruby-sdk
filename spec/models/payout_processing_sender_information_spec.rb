...
# Unit tests for OpenapiClient::PayoutProcessingSenderInformation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PayoutProcessingSenderInformation do
  let(:instance) { OpenapiClient::PayoutProcessingSenderInformation.new }

  describe 'test an instance of PayoutProcessingSenderInformation' do
    it 'should create an instance of PayoutProcessingSenderInformation' do
      expect(instance).to be_instance_of(OpenapiClient::PayoutProcessingSenderInformation)
    end
  end
  ...
  describe 'test attribute "source_of_funds"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Credit", "Debit", "Prepaid", "DepositAccount", "MobileMoneyAccount", "Cash"])
