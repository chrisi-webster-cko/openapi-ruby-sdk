...
# Unit tests for OpenapiClient::SourceRequestCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SourceRequestCustomer do
  let(:instance) { OpenapiClient::SourceRequestCustomer.new }

  describe 'test an instance of SourceRequestCustomer' do
    it 'should create an instance of SourceRequestCustomer' do
      expect(instance).to be_instance_of(OpenapiClient::SourceRequestCustomer)
    end
  end
