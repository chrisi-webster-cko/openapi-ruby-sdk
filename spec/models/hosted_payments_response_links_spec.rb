...
# Unit tests for OpenapiClient::HostedPaymentsResponseLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::HostedPaymentsResponseLinks do
  let(:instance) { OpenapiClient::HostedPaymentsResponseLinks.new }

  describe 'test an instance of HostedPaymentsResponseLinks' do
    it 'should create an instance of HostedPaymentsResponseLinks' do
      expect(instance).to be_instance_of(OpenapiClient::HostedPaymentsResponseLinks)
    end
  end
