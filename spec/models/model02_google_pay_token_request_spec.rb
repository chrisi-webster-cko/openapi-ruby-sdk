...
# Unit tests for OpenapiClient::Model02GooglePayTokenRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model02GooglePayTokenRequest do
  let(:instance) { OpenapiClient::Model02GooglePayTokenRequest.new }

  describe 'test an instance of Model02GooglePayTokenRequest' do
    it 'should create an instance of Model02GooglePayTokenRequest' do
      expect(instance).to be_instance_of(OpenapiClient::Model02GooglePayTokenRequest)
    end
  end
