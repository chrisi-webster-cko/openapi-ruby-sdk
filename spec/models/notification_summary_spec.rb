...
# Unit tests for OpenapiClient::NotificationSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::NotificationSummary do
  let(:instance) { OpenapiClient::NotificationSummary.new }

  describe 'test an instance of NotificationSummary' do
    it 'should create an instance of NotificationSummary' do
      expect(instance).to be_instance_of(OpenapiClient::NotificationSummary)
    end
  end
