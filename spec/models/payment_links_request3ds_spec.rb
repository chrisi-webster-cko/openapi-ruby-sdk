...
# Unit tests for OpenapiClient::PaymentLinksRequest3ds
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentLinksRequest3ds do
  let(:instance) { OpenapiClient::PaymentLinksRequest3ds.new }

  describe 'test an instance of PaymentLinksRequest3ds' do
    it 'should create an instance of PaymentLinksRequest3ds' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentLinksRequest3ds)
    end
  end
