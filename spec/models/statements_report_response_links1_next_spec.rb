...
# Unit tests for OpenapiClient::StatementsReportResponseLinks1Next
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::StatementsReportResponseLinks1Next do
  let(:instance) { OpenapiClient::StatementsReportResponseLinks1Next.new }

  describe 'test an instance of StatementsReportResponseLinks1Next' do
    it 'should create an instance of StatementsReportResponseLinks1Next' do
      expect(instance).to be_instance_of(OpenapiClient::StatementsReportResponseLinks1Next)
    end
  end
