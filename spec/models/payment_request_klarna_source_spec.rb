...
# Unit tests for OpenapiClient::PaymentRequestKlarnaSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestKlarnaSource do
  let(:instance) { OpenapiClient::PaymentRequestKlarnaSource.new }

  describe 'test an instance of PaymentRequestKlarnaSource' do
    it 'should create an instance of PaymentRequestKlarnaSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestKlarnaSource)
    end
  end
