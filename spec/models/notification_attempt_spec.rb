...
# Unit tests for OpenapiClient::NotificationAttempt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::NotificationAttempt do
  let(:instance) { OpenapiClient::NotificationAttempt.new }

  describe 'test an instance of NotificationAttempt' do
    it 'should create an instance of NotificationAttempt' do
      expect(instance).to be_instance_of(OpenapiClient::NotificationAttempt)
    end
  end
