...
# Unit tests for OpenapiClient::WebhookRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WebhookRequest do
  let(:instance) { OpenapiClient::WebhookRequest.new }

  describe 'test an instance of WebhookRequest' do
    it 'should create an instance of WebhookRequest' do
      expect(instance).to be_instance_of(OpenapiClient::WebhookRequest)
    end
  end
