...
# Unit tests for OpenapiClient::Evidence
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Evidence do
  let(:instance) { OpenapiClient::Evidence.new }

  describe 'test an instance of Evidence' do
    it 'should create an instance of Evidence' do
      expect(instance).to be_instance_of(OpenapiClient::Evidence)
    end
  end
