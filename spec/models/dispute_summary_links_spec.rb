...
# Unit tests for OpenapiClient::DisputeSummaryLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DisputeSummaryLinks do
  let(:instance) { OpenapiClient::DisputeSummaryLinks.new }

  describe 'test an instance of DisputeSummaryLinks' do
    it 'should create an instance of DisputeSummaryLinks' do
      expect(instance).to be_instance_of(OpenapiClient::DisputeSummaryLinks)
    end
  end
