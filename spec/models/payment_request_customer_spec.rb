...
# Unit tests for OpenapiClient::PaymentRequestCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestCustomer do
  let(:instance) { OpenapiClient::PaymentRequestCustomer.new }

  describe 'test an instance of PaymentRequestCustomer' do
    it 'should create an instance of PaymentRequestCustomer' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestCustomer)
    end
  end
