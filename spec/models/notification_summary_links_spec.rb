...
# Unit tests for OpenapiClient::NotificationSummaryLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::NotificationSummaryLinks do
  let(:instance) { OpenapiClient::NotificationSummaryLinks.new }

  describe 'test an instance of NotificationSummaryLinks' do
    it 'should create an instance of NotificationSummaryLinks' do
      expect(instance).to be_instance_of(OpenapiClient::NotificationSummaryLinks)
    end
  end
