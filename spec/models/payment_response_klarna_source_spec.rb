...
# Unit tests for OpenapiClient::PaymentResponseKlarnaSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseKlarnaSource do
  let(:instance) { OpenapiClient::PaymentResponseKlarnaSource.new }

  describe 'test an instance of PaymentResponseKlarnaSource' do
    it 'should create an instance of PaymentResponseKlarnaSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseKlarnaSource)
    end
  end
