...
# Unit tests for OpenapiClient::StatementsReportResponseLinks1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::StatementsReportResponseLinks1 do
  let(:instance) { OpenapiClient::StatementsReportResponseLinks1.new }

  describe 'test an instance of StatementsReportResponseLinks1' do
    it 'should create an instance of StatementsReportResponseLinks1' do
      expect(instance).to be_instance_of(OpenapiClient::StatementsReportResponseLinks1)
    end
  end
