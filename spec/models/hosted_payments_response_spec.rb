...
# Unit tests for OpenapiClient::HostedPaymentsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::HostedPaymentsResponse do
  let(:instance) { OpenapiClient::HostedPaymentsResponse.new }

  describe 'test an instance of HostedPaymentsResponse' do
    it 'should create an instance of HostedPaymentsResponse' do
      expect(instance).to be_instance_of(OpenapiClient::HostedPaymentsResponse)
    end
  end
