...
# Unit tests for OpenapiClient::PaymentResponseBancontactSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseBancontactSourceAllOf do
  let(:instance) { OpenapiClient::PaymentResponseBancontactSourceAllOf.new }

  describe 'test an instance of PaymentResponseBancontactSourceAllOf' do
    it 'should create an instance of PaymentResponseBancontactSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseBancontactSourceAllOf)
    end
  end
