...
# Unit tests for OpenapiClient::DisputeLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DisputeLinks do
  let(:instance) { OpenapiClient::DisputeLinks.new }

  describe 'test an instance of DisputeLinks' do
    it 'should create an instance of DisputeLinks' do
      expect(instance).to be_instance_of(OpenapiClient::DisputeLinks)
    end
  end
