...
# Unit tests for OpenapiClient::DisputePaged
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DisputePaged do
  let(:instance) { OpenapiClient::DisputePaged.new }

  describe 'test an instance of DisputePaged' do
    it 'should create an instance of DisputePaged' do
      expect(instance).to be_instance_of(OpenapiClient::DisputePaged)
    end
  end
  ...
  describe 'test attribute "this_channel_only"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
