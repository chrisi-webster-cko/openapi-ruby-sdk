...
# Unit tests for OpenapiClient::PaymentRequestIdealSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestIdealSource do
  let(:instance) { OpenapiClient::PaymentRequestIdealSource.new }

  describe 'test an instance of PaymentRequestIdealSource' do
    it 'should create an instance of PaymentRequestIdealSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestIdealSource)
    end
  end
