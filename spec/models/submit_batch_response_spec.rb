...
# Unit tests for OpenapiClient::SubmitBatchResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SubmitBatchResponse do
  let(:instance) { OpenapiClient::SubmitBatchResponse.new }

  describe 'test an instance of SubmitBatchResponse' do
    it 'should create an instance of SubmitBatchResponse' do
      expect(instance).to be_instance_of(OpenapiClient::SubmitBatchResponse)
    end
  end
