...
# Unit tests for OpenapiClient::PaymentRequestPayPalSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestPayPalSourceAllOf do
  let(:instance) { OpenapiClient::PaymentRequestPayPalSourceAllOf.new }

  describe 'test an instance of PaymentRequestPayPalSourceAllOf' do
    it 'should create an instance of PaymentRequestPayPalSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestPayPalSourceAllOf)
    end
  end
  ...
  describe 'test attribute "stc"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
