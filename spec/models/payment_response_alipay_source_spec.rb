...
# Unit tests for OpenapiClient::PaymentResponseAlipaySource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseAlipaySource do
  let(:instance) { OpenapiClient::PaymentResponseAlipaySource.new }

  describe 'test an instance of PaymentResponseAlipaySource' do
    it 'should create an instance of PaymentResponseAlipaySource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseAlipaySource)
    end
  end
end
