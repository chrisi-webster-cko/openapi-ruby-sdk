...
# Unit tests for OpenapiClient::01SepaSourceAllOfSourceData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::01SepaSourceAllOfSourceData do
  let(:instance) { OpenapiClient::01SepaSourceAllOfSourceData.new }

  describe 'test an instance of 01SepaSourceAllOfSourceData' do
    it 'should create an instance of 01SepaSourceAllOfSourceData' do
      expect(instance).to be_instance_of(OpenapiClient::01SepaSourceAllOfSourceData)
    end
  end
  ...
  describe 'test attribute "mandate_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["single", "recurring"])
      # validator.allowable_values.each do |value|
      #   expect { instance.mandate_type = value }.not_to raise_error
      # end
    end
  end
