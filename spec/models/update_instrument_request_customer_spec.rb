...
# Unit tests for OpenapiClient::UpdateInstrumentRequestCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateInstrumentRequestCustomer do
  let(:instance) { OpenapiClient::UpdateInstrumentRequestCustomer.new }

  describe 'test an instance of UpdateInstrumentRequestCustomer' do
    it 'should create an instance of UpdateInstrumentRequestCustomer' do
      expect(instance).to be_instance_of(OpenapiClient::UpdateInstrumentRequestCustomer)
    end
  end
