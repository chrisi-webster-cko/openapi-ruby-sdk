...
# Unit tests for OpenapiClient::PaymentResponseP24Source
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseP24Source do
  let(:instance) { OpenapiClient::PaymentResponseP24Source.new }

  describe 'test an instance of PaymentResponseP24Source' do
    it 'should create an instance of PaymentResponseP24Source' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseP24Source)
    end
  end
