...
# Unit tests for OpenapiClient::PaymentResponsePagoFacilSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponsePagoFacilSource do
  let(:instance) { OpenapiClient::PaymentResponsePagoFacilSource.new }

  describe 'test an instance of PaymentResponsePagoFacilSource' do
    it 'should create an instance of PaymentResponsePagoFacilSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponsePagoFacilSource)
    end
  end
