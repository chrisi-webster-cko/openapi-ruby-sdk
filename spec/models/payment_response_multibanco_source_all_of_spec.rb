...
# Unit tests for OpenapiClient::PaymentResponseMultibancoSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseMultibancoSourceAllOf do
  let(:instance) { OpenapiClient::PaymentResponseMultibancoSourceAllOf.new }

  describe 'test an instance of PaymentResponseMultibancoSourceAllOf' do
    it 'should create an instance of PaymentResponseMultibancoSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseMultibancoSourceAllOf)
    end
  end
  ...
  describe 'test attribute "service_supplier_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
