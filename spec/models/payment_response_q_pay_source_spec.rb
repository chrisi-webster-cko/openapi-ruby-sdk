...
# Unit tests for OpenapiClient::PaymentResponseQPaySource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseQPaySource do
  let(:instance) { OpenapiClient::PaymentResponseQPaySource.new }

  describe 'test an instance of PaymentResponseQPaySource' do
    it 'should create an instance of PaymentResponseQPaySource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseQPaySource)
    end
  end
