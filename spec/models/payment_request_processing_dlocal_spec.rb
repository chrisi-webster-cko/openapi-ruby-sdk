...
# Unit tests for OpenapiClient::PaymentRequestProcessingDlocal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestProcessingDlocal do
  let(:instance) { OpenapiClient::PaymentRequestProcessingDlocal.new }

  describe 'test an instance of PaymentRequestProcessingDlocal' do
    it 'should create an instance of PaymentRequestProcessingDlocal' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestProcessingDlocal)
    end
  end
