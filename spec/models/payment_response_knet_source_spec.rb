...
# Unit tests for OpenapiClient::PaymentResponseKnetSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseKnetSource do
  let(:instance) { OpenapiClient::PaymentResponseKnetSource.new }

  describe 'test an instance of PaymentResponseKnetSource' do
    it 'should create an instance of PaymentResponseKnetSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseKnetSource)
    end
  end
