...
# Unit tests for OpenapiClient::BillingDescriptor
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BillingDescriptor do
  let(:instance) { OpenapiClient::BillingDescriptor.new }

  describe 'test an instance of BillingDescriptor' do
    it 'should create an instance of BillingDescriptor' do
      expect(instance).to be_instance_of(OpenapiClient::BillingDescriptor)
    end
  end
