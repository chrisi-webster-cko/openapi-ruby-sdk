...
# Unit tests for OpenapiClient::PaymentResponseProcessing
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseProcessing do
  let(:instance) { OpenapiClient::PaymentResponseProcessing.new }

  describe 'test an instance of PaymentResponseProcessing' do
    it 'should create an instance of PaymentResponseProcessing' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseProcessing)
    end
  end
  ...
  describe 'test attribute "acquirer_transaction_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
