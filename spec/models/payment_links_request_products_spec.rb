...
# Unit tests for OpenapiClient::PaymentLinksRequestProducts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentLinksRequestProducts do
  let(:instance) { OpenapiClient::PaymentLinksRequestProducts.new }

  describe 'test an instance of PaymentLinksRequestProducts' do
    it 'should create an instance of PaymentLinksRequestProducts' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentLinksRequestProducts)
    end
  end
