...
# Unit tests for OpenapiClient::03PaymentRequestCardSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::03PaymentRequestCardSourceAllOf do
  let(:instance) { OpenapiClient::03PaymentRequestCardSourceAllOf.new }

  describe 'test an instance of 03PaymentRequestCardSourceAllOf' do
    it 'should create an instance of 03PaymentRequestCardSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::03PaymentRequestCardSourceAllOf)
    end
  end
