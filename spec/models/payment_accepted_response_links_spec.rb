...
# Unit tests for OpenapiClient::PaymentAcceptedResponseLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentAcceptedResponseLinks do
  let(:instance) { OpenapiClient::PaymentAcceptedResponseLinks.new }

  describe 'test an instance of PaymentAcceptedResponseLinks' do
    it 'should create an instance of PaymentAcceptedResponseLinks' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentAcceptedResponseLinks)
    end
  end
