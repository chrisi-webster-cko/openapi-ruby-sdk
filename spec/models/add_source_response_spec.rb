...
# Unit tests for OpenapiClient::AddSourceResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AddSourceResponse do
  let(:instance) { OpenapiClient::AddSourceResponse.new }

  describe 'test an instance of AddSourceResponse' do
    it 'should create an instance of AddSourceResponse' do
      expect(instance).to be_instance_of(OpenapiClient::AddSourceResponse)
    end
  end
