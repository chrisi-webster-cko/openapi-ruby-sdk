...
# Unit tests for OpenapiClient::BatchLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BatchLinks do
  let(:instance) { OpenapiClient::BatchLinks.new }

  describe 'test an instance of BatchLinks' do
    it 'should create an instance of BatchLinks' do
      expect(instance).to be_instance_of(OpenapiClient::BatchLinks)
    end
  end
