...
# Unit tests for OpenapiClient::SelfLink
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SelfLink do
  let(:instance) { OpenapiClient::SelfLink.new }

  describe 'test an instance of SelfLink' do
    it 'should create an instance of SelfLink' do
      expect(instance).to be_instance_of(OpenapiClient::SelfLink)
    end
  end
  describe 'test attribute "rel"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["self"])
