...
# Unit tests for OpenapiClient::PaymentRequestPagoFacilSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestPagoFacilSource do
  let(:instance) { OpenapiClient::PaymentRequestPagoFacilSource.new }

  describe 'test an instance of PaymentRequestPagoFacilSource' do
    it 'should create an instance of PaymentRequestPagoFacilSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestPagoFacilSource)
    end
  end
