...
# Unit tests for OpenapiClient::PaymentRequestShipping
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestShipping do
  let(:instance) { OpenapiClient::PaymentRequestShipping.new }

  describe 'test an instance of PaymentRequestShipping' do
    it 'should create an instance of PaymentRequestShipping' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestShipping)
    end
  end
