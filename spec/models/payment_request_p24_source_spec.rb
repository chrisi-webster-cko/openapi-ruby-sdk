...
# Unit tests for OpenapiClient::PaymentRequestP24Source
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestP24Source do
  let(:instance) { OpenapiClient::PaymentRequestP24Source.new }

  describe 'test an instance of PaymentRequestP24Source' do
    it 'should create an instance of PaymentRequestP24Source' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestP24Source)
    end
  end
