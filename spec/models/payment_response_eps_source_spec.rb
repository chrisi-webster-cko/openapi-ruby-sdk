...
# Unit tests for OpenapiClient::PaymentResponseEpsSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseEpsSource do
  let(:instance) { OpenapiClient::PaymentResponseEpsSource.new }

  describe 'test an instance of PaymentResponseEpsSource' do
    it 'should create an instance of PaymentResponseEpsSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseEpsSource)
    end
  end
