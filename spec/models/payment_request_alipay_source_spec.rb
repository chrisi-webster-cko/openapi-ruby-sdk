...
# Unit tests for OpenapiClient::PaymentRequestAlipaySource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestAlipaySource do
  let(:instance) { OpenapiClient::PaymentRequestAlipaySource.new }

  describe 'test an instance of PaymentRequestAlipaySource' do
    it 'should create an instance of PaymentRequestAlipaySource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestAlipaySource)
    end
  end
end
