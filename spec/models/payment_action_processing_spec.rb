...
# Unit tests for OpenapiClient::PaymentActionProcessing
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentActionProcessing do
  let(:instance) { OpenapiClient::PaymentActionProcessing.new }

  describe 'test an instance of PaymentActionProcessing' do
    it 'should create an instance of PaymentActionProcessing' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentActionProcessing)
    end
  end
