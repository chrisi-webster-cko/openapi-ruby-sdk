...
# Unit tests for OpenapiClient::PaymentsReportResponseLinks1Self
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentsReportResponseLinks1Self do
  let(:instance) { OpenapiClient::PaymentsReportResponseLinks1Self.new }

  describe 'test an instance of PaymentsReportResponseLinks1Self' do
    it 'should create an instance of PaymentsReportResponseLinks1Self' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentsReportResponseLinks1Self)
    end
  end
