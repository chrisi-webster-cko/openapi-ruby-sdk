...
# Unit tests for OpenapiClient::PaymentAcceptedResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentAcceptedResponse do
  let(:instance) { OpenapiClient::PaymentAcceptedResponse.new }

  describe 'test an instance of PaymentAcceptedResponse' do
    it 'should create an instance of PaymentAcceptedResponse' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentAcceptedResponse)
    end
  end
