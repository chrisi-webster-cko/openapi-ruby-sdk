...
# Unit tests for OpenapiClient::HostedPaymentsRequestProducts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::HostedPaymentsRequestProducts do
  let(:instance) { OpenapiClient::HostedPaymentsRequestProducts.new }

  describe 'test an instance of HostedPaymentsRequestProducts' do
    it 'should create an instance of HostedPaymentsRequestProducts' do
      expect(instance).to be_instance_of(OpenapiClient::HostedPaymentsRequestProducts)
    end
  end
