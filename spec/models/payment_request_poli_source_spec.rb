...
# Unit tests for OpenapiClient::PaymentRequestPoliSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestPoliSource do
  let(:instance) { OpenapiClient::PaymentRequestPoliSource.new }

  describe 'test an instance of PaymentRequestPoliSource' do
    it 'should create an instance of PaymentRequestPoliSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestPoliSource)
    end
  end
end
