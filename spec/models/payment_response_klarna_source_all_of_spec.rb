...
# Unit tests for OpenapiClient::PaymentResponseKlarnaSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseKlarnaSourceAllOf do
  let(:instance) { OpenapiClient::PaymentResponseKlarnaSourceAllOf.new }

  describe 'test an instance of PaymentResponseKlarnaSourceAllOf' do
    it 'should create an instance of PaymentResponseKlarnaSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseKlarnaSourceAllOf)
    end
  end
