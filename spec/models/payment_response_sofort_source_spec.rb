...
# Unit tests for OpenapiClient::PaymentResponseSofortSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseSofortSource do
  let(:instance) { OpenapiClient::PaymentResponseSofortSource.new }

  describe 'test an instance of PaymentResponseSofortSource' do
    it 'should create an instance of PaymentResponseSofortSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseSofortSource)
    end
  end
