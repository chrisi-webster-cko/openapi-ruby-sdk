...
# Unit tests for OpenapiClient::Model3dsEnrollmentData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model3dsEnrollmentData do
  let(:instance) { OpenapiClient::Model3dsEnrollmentData.new }

  describe 'test an instance of Model3dsEnrollmentData' do
    it 'should create an instance of Model3dsEnrollmentData' do
      expect(instance).to be_instance_of(OpenapiClient::Model3dsEnrollmentData)
    end
  end
