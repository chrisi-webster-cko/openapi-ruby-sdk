...
# Unit tests for OpenapiClient::PaymentRequestBoletoSourceAllOfPayer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestBoletoSourceAllOfPayer do
  let(:instance) { OpenapiClient::PaymentRequestBoletoSourceAllOfPayer.new }

  describe 'test an instance of PaymentRequestBoletoSourceAllOfPayer' do
    it 'should create an instance of PaymentRequestBoletoSourceAllOfPayer' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestBoletoSourceAllOfPayer)
    end
  end
