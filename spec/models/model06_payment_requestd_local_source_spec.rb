...
# Unit tests for OpenapiClient::Model06PaymentRequestdLocalSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model06PaymentRequestdLocalSource do
  let(:instance) { OpenapiClient::Model06PaymentRequestdLocalSource.new }

  describe 'test an instance of Model06PaymentRequestdLocalSource' do
    it 'should create an instance of Model06PaymentRequestdLocalSource' do
      expect(instance).to be_instance_of(OpenapiClient::Model06PaymentRequestdLocalSource)
    end
  end
