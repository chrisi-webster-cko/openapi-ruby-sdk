...
# Unit tests for OpenapiClient::PaymentRequestOXXOSourceAllOfPayer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestOXXOSourceAllOfPayer do
  let(:instance) { OpenapiClient::PaymentRequestOXXOSourceAllOfPayer.new }

  describe 'test an instance of PaymentRequestOXXOSourceAllOfPayer' do
    it 'should create an instance of PaymentRequestOXXOSourceAllOfPayer' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestOXXOSourceAllOfPayer)
    end
  end
