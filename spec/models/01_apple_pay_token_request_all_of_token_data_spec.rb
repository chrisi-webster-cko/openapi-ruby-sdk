...
# Unit tests for OpenapiClient::01ApplePayTokenRequestAllOfTokenData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::01ApplePayTokenRequestAllOfTokenData do
  let(:instance) { OpenapiClient::01ApplePayTokenRequestAllOfTokenData.new }

  describe 'test an instance of 01ApplePayTokenRequestAllOfTokenData' do
    it 'should create an instance of 01ApplePayTokenRequestAllOfTokenData' do
      expect(instance).to be_instance_of(OpenapiClient::01ApplePayTokenRequestAllOfTokenData)
    end
  end
