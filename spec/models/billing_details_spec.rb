...
# Unit tests for OpenapiClient::BillingDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BillingDetails do
  let(:instance) { OpenapiClient::BillingDetails.new }

  describe 'test an instance of BillingDetails' do
    it 'should create an instance of BillingDetails' do
      expect(instance).to be_instance_of(OpenapiClient::BillingDetails)
    end
  end
