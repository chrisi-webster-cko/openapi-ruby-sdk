...
# Unit tests for OpenapiClient::RefundRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::RefundRequest do
  let(:instance) { OpenapiClient::RefundRequest.new }

  describe 'test an instance of RefundRequest' do
    it 'should create an instance of RefundRequest' do
      expect(instance).to be_instance_of(OpenapiClient::RefundRequest)
    end
  end
