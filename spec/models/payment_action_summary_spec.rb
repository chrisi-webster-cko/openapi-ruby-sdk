...
# Unit tests for OpenapiClient::PaymentActionSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentActionSummary do
  let(:instance) { OpenapiClient::PaymentActionSummary.new }

  describe 'test an instance of PaymentActionSummary' do
    it 'should create an instance of PaymentActionSummary' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentActionSummary)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Authorization", "Card Verification", "Void", "Capture", "Refund"])
