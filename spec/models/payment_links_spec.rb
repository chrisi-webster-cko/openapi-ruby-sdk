...
# Unit tests for OpenapiClient::PaymentLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentLinks do
  let(:instance) { OpenapiClient::PaymentLinks.new }

  describe 'test an instance of PaymentLinks' do
    it 'should create an instance of PaymentLinks' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentLinks)
    end
  end
