...
# Unit tests for OpenapiClient::PaymentRisk
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRisk do
  let(:instance) { OpenapiClient::PaymentRisk.new }

  describe 'test an instance of PaymentRisk' do
    it 'should create an instance of PaymentRisk' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRisk)
    end
  end
