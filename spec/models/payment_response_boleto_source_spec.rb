...
# Unit tests for OpenapiClient::PaymentResponseBoletoSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseBoletoSource do
  let(:instance) { OpenapiClient::PaymentResponseBoletoSource.new }

  describe 'test an instance of PaymentResponseBoletoSource' do
    it 'should create an instance of PaymentResponseBoletoSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseBoletoSource)
    end
  end
