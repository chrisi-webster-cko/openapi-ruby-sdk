...
# Unit tests for OpenapiClient::PaymentRequestOXXOSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestOXXOSource do
  let(:instance) { OpenapiClient::PaymentRequestOXXOSource.new }

  describe 'test an instance of PaymentRequestOXXOSource' do
    it 'should create an instance of PaymentRequestOXXOSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestOXXOSource)
    end
  end
