...
# Unit tests for OpenapiClient::PaymentResponseOXXOSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseOXXOSource do
  let(:instance) { OpenapiClient::PaymentResponseOXXOSource.new }

  describe 'test an instance of PaymentResponseOXXOSource' do
    it 'should create an instance of PaymentResponseOXXOSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseOXXOSource)
    end
  end
