...
# Unit tests for OpenapiClient::InstrumentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::InstrumentRequest do
  let(:instance) { OpenapiClient::InstrumentRequest.new }

  describe 'test an instance of InstrumentRequest' do
    it 'should create an instance of InstrumentRequest' do
      expect(instance).to be_instance_of(OpenapiClient::InstrumentRequest)
    end
  end
