...
# Unit tests for OpenapiClient::StatementsReportResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::StatementsReportResponse do
  let(:instance) { OpenapiClient::StatementsReportResponse.new }

  describe 'test an instance of StatementsReportResponse' do
    it 'should create an instance of StatementsReportResponse' do
      expect(instance).to be_instance_of(OpenapiClient::StatementsReportResponse)
    end
  end
