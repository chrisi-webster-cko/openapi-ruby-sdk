...
# Unit tests for OpenapiClient::PaymentRequestBenefitPaySourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestBenefitPaySourceAllOf do
  let(:instance) { OpenapiClient::PaymentRequestBenefitPaySourceAllOf.new }

  describe 'test an instance of PaymentRequestBenefitPaySourceAllOf' do
    it 'should create an instance of PaymentRequestBenefitPaySourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestBenefitPaySourceAllOf)
    end
  end
  describe 'test attribute "integration_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["web", "mobile"])
