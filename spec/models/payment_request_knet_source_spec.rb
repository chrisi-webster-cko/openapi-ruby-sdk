...
# Unit tests for OpenapiClient::PaymentRequestKnetSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestKnetSource do
  let(:instance) { OpenapiClient::PaymentRequestKnetSource.new }

  describe 'test an instance of PaymentRequestKnetSource' do
    it 'should create an instance of PaymentRequestKnetSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestKnetSource)
    end
  end
