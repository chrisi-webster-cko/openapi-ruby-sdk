...
# Unit tests for OpenapiClient::PaymentResponseGiropaySource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseGiropaySource do
  let(:instance) { OpenapiClient::PaymentResponseGiropaySource.new }

  describe 'test an instance of PaymentResponseGiropaySource' do
    it 'should create an instance of PaymentResponseGiropaySource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseGiropaySource)
    end
  end
