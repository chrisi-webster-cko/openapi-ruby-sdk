...
# Unit tests for OpenapiClient::03PaymentRequestCardDestinationAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::03PaymentRequestCardDestinationAllOf do
  let(:instance) { OpenapiClient::03PaymentRequestCardDestinationAllOf.new }

  describe 'test an instance of 03PaymentRequestCardDestinationAllOf' do
    it 'should create an instance of 03PaymentRequestCardDestinationAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::03PaymentRequestCardDestinationAllOf)
    end
  end
