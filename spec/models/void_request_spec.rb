...
# Unit tests for OpenapiClient::VoidRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::VoidRequest do
  let(:instance) { OpenapiClient::VoidRequest.new }

  describe 'test an instance of VoidRequest' do
    it 'should create an instance of VoidRequest' do
      expect(instance).to be_instance_of(OpenapiClient::VoidRequest)
    end
  end
