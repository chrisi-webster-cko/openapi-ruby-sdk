...
# Unit tests for OpenapiClient::Model01PaymentResponseCardDestination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model01PaymentResponseCardDestination do
  let(:instance) { OpenapiClient::Model01PaymentResponseCardDestination.new }

  describe 'test an instance of Model01PaymentResponseCardDestination' do
    it 'should create an instance of Model01PaymentResponseCardDestination' do
      expect(instance).to be_instance_of(OpenapiClient::Model01PaymentResponseCardDestination)
    end
  end
