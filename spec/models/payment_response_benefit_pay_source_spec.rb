...
# Unit tests for OpenapiClient::PaymentResponseBenefitPaySource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseBenefitPaySource do
  let(:instance) { OpenapiClient::PaymentResponseBenefitPaySource.new }

  describe 'test an instance of PaymentResponseBenefitPaySource' do
    it 'should create an instance of PaymentResponseBenefitPaySource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseBenefitPaySource)
    end
  end
