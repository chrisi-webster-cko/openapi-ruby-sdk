...
# Unit tests for OpenapiClient::PaymentRequestMultibancoSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestMultibancoSourceAllOf do
  let(:instance) { OpenapiClient::PaymentRequestMultibancoSourceAllOf.new }

  describe 'test an instance of PaymentRequestMultibancoSourceAllOf' do
    it 'should create an instance of PaymentRequestMultibancoSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestMultibancoSourceAllOf)
    end
  end
  describe 'test attribute "payment_country"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["PT"])
