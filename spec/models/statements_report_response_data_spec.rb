...
# Unit tests for OpenapiClient::StatementsReportResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::StatementsReportResponseData do
  let(:instance) { OpenapiClient::StatementsReportResponseData.new }

  describe 'test an instance of StatementsReportResponseData' do
    it 'should create an instance of StatementsReportResponseData' do
      expect(instance).to be_instance_of(OpenapiClient::StatementsReportResponseData)
    end
  end
