...
# Unit tests for OpenapiClient::PaymentRequestSofortSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestSofortSource do
  let(:instance) { OpenapiClient::PaymentRequestSofortSource.new }

  describe 'test an instance of PaymentRequestSofortSource' do
    it 'should create an instance of PaymentRequestSofortSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestSofortSource)
    end
  end
