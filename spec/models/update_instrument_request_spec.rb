...
# Unit tests for OpenapiClient::UpdateInstrumentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateInstrumentRequest do
  let(:instance) { OpenapiClient::UpdateInstrumentRequest.new }

  describe 'test an instance of UpdateInstrumentRequest' do
    it 'should create an instance of UpdateInstrumentRequest' do
      expect(instance).to be_instance_of(OpenapiClient::UpdateInstrumentRequest)
    end
  end
