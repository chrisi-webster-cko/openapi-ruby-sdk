...
# Unit tests for OpenapiClient::PaymentRequestPayPalSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestPayPalSource do
  let(:instance) { OpenapiClient::PaymentRequestPayPalSource.new }

  describe 'test an instance of PaymentRequestPayPalSource' do
    it 'should create an instance of PaymentRequestPayPalSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestPayPalSource)
    end
  end
