...
# Unit tests for OpenapiClient::02GooglePayTokenRequestAllOfTokenData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::02GooglePayTokenRequestAllOfTokenData do
  let(:instance) { OpenapiClient::02GooglePayTokenRequestAllOfTokenData.new }

  describe 'test an instance of 02GooglePayTokenRequestAllOfTokenData' do
    it 'should create an instance of 02GooglePayTokenRequestAllOfTokenData' do
      expect(instance).to be_instance_of(OpenapiClient::02GooglePayTokenRequestAllOfTokenData)
    end
  end
  ...
  describe 'test attribute "signed_message"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
