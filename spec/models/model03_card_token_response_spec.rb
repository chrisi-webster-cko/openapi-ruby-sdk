...
# Unit tests for OpenapiClient::Model03CardTokenResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model03CardTokenResponse do
  let(:instance) { OpenapiClient::Model03CardTokenResponse.new }

  describe 'test an instance of Model03CardTokenResponse' do
    it 'should create an instance of Model03CardTokenResponse' do
      expect(instance).to be_instance_of(OpenapiClient::Model03CardTokenResponse)
    end
  end
