...
# Unit tests for OpenapiClient::PaymentRequestSofortSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestSofortSourceAllOf do
  let(:instance) { OpenapiClient::PaymentRequestSofortSourceAllOf.new }

  describe 'test an instance of PaymentRequestSofortSourceAllOf' do
    it 'should create an instance of PaymentRequestSofortSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestSofortSourceAllOf)
    end
  end
