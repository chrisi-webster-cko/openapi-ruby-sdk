...
# Unit tests for OpenapiClient::01SepaSourceResponseAllOfLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::01SepaSourceResponseAllOfLinks do
  let(:instance) { OpenapiClient::01SepaSourceResponseAllOfLinks.new }

  describe 'test an instance of 01SepaSourceResponseAllOfLinks' do
    it 'should create an instance of 01SepaSourceResponseAllOfLinks' do
      expect(instance).to be_instance_of(OpenapiClient::01SepaSourceResponseAllOfLinks)
    end
  end
