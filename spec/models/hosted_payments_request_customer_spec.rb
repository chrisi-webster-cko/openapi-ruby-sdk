...
# Unit tests for OpenapiClient::HostedPaymentsRequestCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::HostedPaymentsRequestCustomer do
  let(:instance) { OpenapiClient::HostedPaymentsRequestCustomer.new }

  describe 'test an instance of HostedPaymentsRequestCustomer' do
    it 'should create an instance of HostedPaymentsRequestCustomer' do
      expect(instance).to be_instance_of(OpenapiClient::HostedPaymentsRequestCustomer)
    end
  end
