...
# Unit tests for OpenapiClient::HostedPaymentsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::HostedPaymentsRequest do
  let(:instance) { OpenapiClient::HostedPaymentsRequest.new }

  describe 'test an instance of HostedPaymentsRequest' do
    it 'should create an instance of HostedPaymentsRequest' do
      expect(instance).to be_instance_of(OpenapiClient::HostedPaymentsRequest)
    end
  end
