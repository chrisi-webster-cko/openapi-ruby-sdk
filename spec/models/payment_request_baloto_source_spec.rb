...
# Unit tests for OpenapiClient::PaymentRequestBalotoSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestBalotoSource do
  let(:instance) { OpenapiClient::PaymentRequestBalotoSource.new }

  describe 'test an instance of PaymentRequestBalotoSource' do
    it 'should create an instance of PaymentRequestBalotoSource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestBalotoSource)
    end
  end
