...
# Unit tests for OpenapiClient::PaymentRequestFawrySourceAllOfProducts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestFawrySourceAllOfProducts do
  let(:instance) { OpenapiClient::PaymentRequestFawrySourceAllOfProducts.new }

  describe 'test an instance of PaymentRequestFawrySourceAllOfProducts' do
    it 'should create an instance of PaymentRequestFawrySourceAllOfProducts' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestFawrySourceAllOfProducts)
    end
  end
