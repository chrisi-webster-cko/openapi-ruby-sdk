...
# Unit tests for OpenapiClient::FileResultLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::FileResultLinks do
  let(:instance) { OpenapiClient::FileResultLinks.new }

  describe 'test an instance of FileResultLinks' do
    it 'should create an instance of FileResultLinks' do
      expect(instance).to be_instance_of(OpenapiClient::FileResultLinks)
    end
  end
