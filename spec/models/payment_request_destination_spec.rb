...
# Unit tests for OpenapiClient::PaymentRequestDestination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestDestination do
  let(:instance) { OpenapiClient::PaymentRequestDestination.new }

  describe 'test an instance of PaymentRequestDestination' do
    it 'should create an instance of PaymentRequestDestination' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestDestination)
    end
  end
