...
# Unit tests for OpenapiClient::PaymentResponseFawrySourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseFawrySourceAllOf do
  let(:instance) { OpenapiClient::PaymentResponseFawrySourceAllOf.new }

  describe 'test an instance of PaymentResponseFawrySourceAllOf' do
    it 'should create an instance of PaymentResponseFawrySourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseFawrySourceAllOf)
    end
  end
