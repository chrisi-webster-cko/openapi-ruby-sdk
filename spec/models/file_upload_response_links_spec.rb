...
# Unit tests for OpenapiClient::FileUploadResponseLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::FileUploadResponseLinks do
  let(:instance) { OpenapiClient::FileUploadResponseLinks.new }

  describe 'test an instance of FileUploadResponseLinks' do
    it 'should create an instance of FileUploadResponseLinks' do
      expect(instance).to be_instance_of(OpenapiClient::FileUploadResponseLinks)
    end
  end
