...
# Unit tests for OpenapiClient::ShippingDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ShippingDetails do
  let(:instance) { OpenapiClient::ShippingDetails.new }

  describe 'test an instance of ShippingDetails' do
    it 'should create an instance of ShippingDetails' do
      expect(instance).to be_instance_of(OpenapiClient::ShippingDetails)
    end
  end
