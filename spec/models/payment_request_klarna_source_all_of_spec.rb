...
# Unit tests for OpenapiClient::PaymentRequestKlarnaSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestKlarnaSourceAllOf do
  let(:instance) { OpenapiClient::PaymentRequestKlarnaSourceAllOf.new }

  describe 'test an instance of PaymentRequestKlarnaSourceAllOf' do
    it 'should create an instance of PaymentRequestKlarnaSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestKlarnaSourceAllOf)
    end
  end
  ...
  describe 'test attribute "merchant_reference1"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "merchant_reference2"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
