...
# Unit tests for OpenapiClient::PaymentLinksRequestCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentLinksRequestCustomer do
  let(:instance) { OpenapiClient::PaymentLinksRequestCustomer.new }

  describe 'test an instance of PaymentLinksRequestCustomer' do
    it 'should create an instance of PaymentLinksRequestCustomer' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentLinksRequestCustomer)
    end
  end
