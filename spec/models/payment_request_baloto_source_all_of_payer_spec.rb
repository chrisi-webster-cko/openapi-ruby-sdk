...
# Unit tests for OpenapiClient::PaymentRequestBalotoSourceAllOfPayer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestBalotoSourceAllOfPayer do
  let(:instance) { OpenapiClient::PaymentRequestBalotoSourceAllOfPayer.new }

  describe 'test an instance of PaymentRequestBalotoSourceAllOfPayer' do
    it 'should create an instance of PaymentRequestBalotoSourceAllOfPayer' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestBalotoSourceAllOfPayer)
    end
  end
