...
# Unit tests for OpenapiClient::PaymentRequestOXXOSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestOXXOSourceAllOf do
  let(:instance) { OpenapiClient::PaymentRequestOXXOSourceAllOf.new }

  describe 'test an instance of PaymentRequestOXXOSourceAllOf' do
    it 'should create an instance of PaymentRequestOXXOSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestOXXOSourceAllOf)
    end
  end
  ...
  describe 'test attribute "country"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["MX"])
      # validator.allowable_values.each do |value|
