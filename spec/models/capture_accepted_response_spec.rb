...
# Unit tests for OpenapiClient::CaptureAcceptedResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CaptureAcceptedResponse do
  let(:instance) { OpenapiClient::CaptureAcceptedResponse.new }

  describe 'test an instance of CaptureAcceptedResponse' do
    it 'should create an instance of CaptureAcceptedResponse' do
      expect(instance).to be_instance_of(OpenapiClient::CaptureAcceptedResponse)
    end
  end
