...
# Unit tests for OpenapiClient::PagingError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PagingError do
  let(:instance) { OpenapiClient::PagingError.new }

  describe 'test an instance of PagingError' do
    it 'should create an instance of PagingError' do
      expect(instance).to be_instance_of(OpenapiClient::PagingError)
    end
  end
