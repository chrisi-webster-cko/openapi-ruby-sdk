...
# Unit tests for OpenapiClient::CaptureRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CaptureRequest do
  let(:instance) { OpenapiClient::CaptureRequest.new }

  describe 'test an instance of CaptureRequest' do
    it 'should create an instance of CaptureRequest' do
      expect(instance).to be_instance_of(OpenapiClient::CaptureRequest)
    end
  end
