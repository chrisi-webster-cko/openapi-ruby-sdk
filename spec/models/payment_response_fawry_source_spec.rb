...
# Unit tests for OpenapiClient::PaymentResponseFawrySource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseFawrySource do
  let(:instance) { OpenapiClient::PaymentResponseFawrySource.new }

  describe 'test an instance of PaymentResponseFawrySource' do
    it 'should create an instance of PaymentResponseFawrySource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseFawrySource)
    end
  end
