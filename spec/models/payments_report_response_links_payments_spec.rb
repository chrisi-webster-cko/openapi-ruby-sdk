...
# Unit tests for OpenapiClient::PaymentsReportResponseLinksPayments
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentsReportResponseLinksPayments do
  let(:instance) { OpenapiClient::PaymentsReportResponseLinksPayments.new }

  describe 'test an instance of PaymentsReportResponseLinksPayments' do
    it 'should create an instance of PaymentsReportResponseLinksPayments' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentsReportResponseLinksPayments)
    end
  end
