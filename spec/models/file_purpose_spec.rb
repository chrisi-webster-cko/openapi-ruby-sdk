...
# Unit tests for OpenapiClient::FilePurpose
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::FilePurpose do
  let(:instance) { OpenapiClient::FilePurpose.new }

  describe 'test an instance of FilePurpose' do
    it 'should create an instance of FilePurpose' do
      expect(instance).to be_instance_of(OpenapiClient::FilePurpose)
    end
  end
end
