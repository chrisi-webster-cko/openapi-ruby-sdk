...
# Unit tests for OpenapiClient::PaymentResponseP24SourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseP24SourceAllOf do
  let(:instance) { OpenapiClient::PaymentResponseP24SourceAllOf.new }

  describe 'test an instance of PaymentResponseP24SourceAllOf' do
    it 'should create an instance of PaymentResponseP24SourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseP24SourceAllOf)
    end
  end
  describe 'test attribute "p24_descriptor"' do
    it 'should work' do
