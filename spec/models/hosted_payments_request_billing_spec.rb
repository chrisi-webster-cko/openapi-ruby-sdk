...
# Unit tests for OpenapiClient::HostedPaymentsRequestBilling
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::HostedPaymentsRequestBilling do
  let(:instance) { OpenapiClient::HostedPaymentsRequestBilling.new }

  describe 'test an instance of HostedPaymentsRequestBilling' do
    it 'should create an instance of HostedPaymentsRequestBilling' do
      expect(instance).to be_instance_of(OpenapiClient::HostedPaymentsRequestBilling)
    end
  end
