...
# Unit tests for OpenapiClient::PaymentRequestFawrySource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestFawrySource do
  let(:instance) { OpenapiClient::PaymentRequestFawrySource.new }

  describe 'test an instance of PaymentRequestFawrySource' do
    it 'should create an instance of PaymentRequestFawrySource' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestFawrySource)
    end
  end
