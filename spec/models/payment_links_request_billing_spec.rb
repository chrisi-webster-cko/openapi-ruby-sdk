...
# Unit tests for OpenapiClient::PaymentLinksRequestBilling
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentLinksRequestBilling do
  let(:instance) { OpenapiClient::PaymentLinksRequestBilling.new }

  describe 'test an instance of PaymentLinksRequestBilling' do
    it 'should create an instance of PaymentLinksRequestBilling' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentLinksRequestBilling)
    end
  end
