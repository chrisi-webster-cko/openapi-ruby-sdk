...
# Unit tests for OpenapiClient::EventLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EventLinks do
  let(:instance) { OpenapiClient::EventLinks.new }

  describe 'test an instance of EventLinks' do
    it 'should create an instance of EventLinks' do
      expect(instance).to be_instance_of(OpenapiClient::EventLinks)
    end
  end
  ...
  describe 'test attribute "webhooks_retry"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
