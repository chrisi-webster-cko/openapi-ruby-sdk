...
# Unit tests for OpenapiClient::Model02AchSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model02AchSource do
  let(:instance) { OpenapiClient::Model02AchSource.new }

  describe 'test an instance of Model02AchSource' do
    it 'should create an instance of Model02AchSource' do
      expect(instance).to be_instance_of(OpenapiClient::Model02AchSource)
    end
  end
