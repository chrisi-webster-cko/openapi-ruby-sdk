...
# Unit tests for OpenapiClient::01PaymentResponseCardSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::01PaymentResponseCardSourceAllOf do
  let(:instance) { OpenapiClient::01PaymentResponseCardSourceAllOf.new }

  describe 'test an instance of 01PaymentResponseCardSourceAllOf' do
    it 'should create an instance of 01PaymentResponseCardSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::01PaymentResponseCardSourceAllOf)
    end
  end
