...
# Unit tests for OpenapiClient::PaymentRequestFawrySourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestFawrySourceAllOf do
  let(:instance) { OpenapiClient::PaymentRequestFawrySourceAllOf.new }

  describe 'test an instance of PaymentRequestFawrySourceAllOf' do
    it 'should create an instance of PaymentRequestFawrySourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestFawrySourceAllOf)
    end
  end
  ...
  describe 'test attribute "customer_mobile"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
