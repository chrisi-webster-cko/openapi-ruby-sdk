...
# Unit tests for OpenapiClient::RetrieveInstrumentResponseAccountHolder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::RetrieveInstrumentResponseAccountHolder do
  let(:instance) { OpenapiClient::RetrieveInstrumentResponseAccountHolder.new }

  describe 'test an instance of RetrieveInstrumentResponseAccountHolder' do
    it 'should create an instance of RetrieveInstrumentResponseAccountHolder' do
      expect(instance).to be_instance_of(OpenapiClient::RetrieveInstrumentResponseAccountHolder)
    end
  end
