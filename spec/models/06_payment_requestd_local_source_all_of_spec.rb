...
# Unit tests for OpenapiClient::06PaymentRequestdLocalSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::06PaymentRequestdLocalSourceAllOf do
  let(:instance) { OpenapiClient::06PaymentRequestdLocalSourceAllOf.new }

  describe 'test an instance of 06PaymentRequestdLocalSourceAllOf' do
    it 'should create an instance of 06PaymentRequestdLocalSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::06PaymentRequestdLocalSourceAllOf)
    end
  end
