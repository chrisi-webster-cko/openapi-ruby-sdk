...
# Unit tests for OpenapiClient::PayoutProcessing
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PayoutProcessing do
  let(:instance) { OpenapiClient::PayoutProcessing.new }

  describe 'test an instance of PayoutProcessing' do
    it 'should create an instance of PayoutProcessing' do
      expect(instance).to be_instance_of(OpenapiClient::PayoutProcessing)
    end
  end
