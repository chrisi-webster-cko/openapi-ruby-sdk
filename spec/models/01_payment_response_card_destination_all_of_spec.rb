...
# Unit tests for OpenapiClient::01PaymentResponseCardDestinationAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::01PaymentResponseCardDestinationAllOf do
  let(:instance) { OpenapiClient::01PaymentResponseCardDestinationAllOf.new }

  describe 'test an instance of 01PaymentResponseCardDestinationAllOf' do
    it 'should create an instance of 01PaymentResponseCardDestinationAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::01PaymentResponseCardDestinationAllOf)
    end
  end
