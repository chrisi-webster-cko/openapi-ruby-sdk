...
# Unit tests for OpenapiClient::PaymentRequestEpsSourceAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentRequestEpsSourceAllOf do
  let(:instance) { OpenapiClient::PaymentRequestEpsSourceAllOf.new }

  describe 'test an instance of PaymentRequestEpsSourceAllOf' do
    it 'should create an instance of PaymentRequestEpsSourceAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentRequestEpsSourceAllOf)
    end
  end
