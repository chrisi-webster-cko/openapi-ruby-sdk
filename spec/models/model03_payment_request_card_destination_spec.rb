...
# Unit tests for OpenapiClient::Model03PaymentRequestCardDestination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Model03PaymentRequestCardDestination do
  let(:instance) { OpenapiClient::Model03PaymentRequestCardDestination.new }

  describe 'test an instance of Model03PaymentRequestCardDestination' do
    it 'should create an instance of Model03PaymentRequestCardDestination' do
      expect(instance).to be_instance_of(OpenapiClient::Model03PaymentRequestCardDestination)
    end
  end
