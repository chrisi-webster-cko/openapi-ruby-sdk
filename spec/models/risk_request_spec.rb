...
# Unit tests for OpenapiClient::RiskRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::RiskRequest do
  let(:instance) { OpenapiClient::RiskRequest.new }

  describe 'test an instance of RiskRequest' do
    it 'should create an instance of RiskRequest' do
      expect(instance).to be_instance_of(OpenapiClient::RiskRequest)
    end
  end
