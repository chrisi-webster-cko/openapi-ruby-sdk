...
# Unit tests for OpenapiClient::PaymentsReportResponseLinks1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentsReportResponseLinks1 do
  let(:instance) { OpenapiClient::PaymentsReportResponseLinks1.new }

  describe 'test an instance of PaymentsReportResponseLinks1' do
    it 'should create an instance of PaymentsReportResponseLinks1' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentsReportResponseLinks1)
    end
  end
