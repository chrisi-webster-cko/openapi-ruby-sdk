...
# Unit tests for OpenapiClient::01ApplePayTokenRequestAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::01ApplePayTokenRequestAllOf do
  let(:instance) { OpenapiClient::01ApplePayTokenRequestAllOf.new }

  describe 'test an instance of 01ApplePayTokenRequestAllOf' do
    it 'should create an instance of 01ApplePayTokenRequestAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::01ApplePayTokenRequestAllOf)
    end
  end
