...
# Unit tests for OpenapiClient::PaymentResponseCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentResponseCustomer do
  let(:instance) { OpenapiClient::PaymentResponseCustomer.new }

  describe 'test an instance of PaymentResponseCustomer' do
    it 'should create an instance of PaymentResponseCustomer' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentResponseCustomer)
    end
  end
