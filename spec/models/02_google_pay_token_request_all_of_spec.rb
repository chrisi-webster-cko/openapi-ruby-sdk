...
# Unit tests for OpenapiClient::02GooglePayTokenRequestAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::02GooglePayTokenRequestAllOf do
  let(:instance) { OpenapiClient::02GooglePayTokenRequestAllOf.new }

  describe 'test an instance of 02GooglePayTokenRequestAllOf' do
    it 'should create an instance of 02GooglePayTokenRequestAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::02GooglePayTokenRequestAllOf)
    end
  end
