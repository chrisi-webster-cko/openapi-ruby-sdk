...
# Unit tests for OpenapiClient::PaymentsReportResponseActions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentsReportResponseActions do
  let(:instance) { OpenapiClient::PaymentsReportResponseActions.new }

  describe 'test an instance of PaymentsReportResponseActions' do
    it 'should create an instance of PaymentsReportResponseActions' do
      expect(instance).to be_instance_of(OpenapiClient::PaymentsReportResponseActions)
    end
  end
  ...
  describe 'test attribute "response_description"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
