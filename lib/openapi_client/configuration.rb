...
module OpenapiClient
  class Configuration
        ...
        'ApiPublicKey' =>
          {
            ...
            in: 'header',
            key: 'Authorization',
            value: api_key_with_prefix('ApiPublicKey')
          },
        'ApiSecretKey' =>
          {
            type: 'api_key',
            in: 'header',
            key: 'Authorization',
            value: api_key_with_prefix('ApiSecretKey')
          },
      }
    end
    ...
    def operation_server_settings
      {
        "ReconciliationApi.get_csv_payments_report": [
          {
          url: "https://api.checkout.com",
          description: "Live API",
          }
        ],
        "ReconciliationApi.get_csv_single_statement_report": [
          {
          url: "https://api.checkout.com",
          description: "Live API",
          }
        ],
        "ReconciliationApi.get_csv_statements_report": [
          {
          url: "https://api.checkout.com",
          description: "Live API",
          }
        ],
        "ReconciliationApi.get_json_payments_report": [
          {
          url: "https://api.checkout.com",
          description: "Live API",
          }
        ],
        "ReconciliationApi.get_json_single_payment_report": [
          {
          url: "https://api.checkout.com",
          description: "Live API",
          }
        ],
        "ReconciliationApi.get_json_statements_report": [
          {
          url: "https://api.checkout.com",
          description: "Live API",
          }
