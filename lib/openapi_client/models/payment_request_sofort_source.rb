...
module OpenapiClient
  # Sofort Source
  class PaymentRequestSofortSource < PaymentRequestSource
    # The ISO 3166-1 alpha-2 country code. For example DE, FR, IT.
    attr_accessor :country_code

    # The ISO 639-1 language code. For example de, fr, it.
    ...
    def self.openapi_all_of
      [
      :'PaymentRequestSofortSourceAllOf',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentRequestSofortSource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentRequestSofortSource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          language_code == o.language_code && super(o)
    end
