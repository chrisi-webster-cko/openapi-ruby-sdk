...
module OpenapiClient
  class HostedPaymentsRequestProducts
    # Descriptive item name
    attr_accessor :name

    # The item quantity. Non-negative
    attr_accessor :quantity

    # Minor units. Includes tax, excludes discounts. The exact format <a href=\"https://docs.checkout.com/docs/calculating-the-value\" target=\"_blank\">depends on the currency</a>
    attr_accessor :price
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::HostedPaymentsRequestProducts` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::HostedPaymentsRequestProducts`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @price > 100000000
        invalid_properties.push('invalid value for "price", must be smaller than or equal to 100000000.')
      end
    ...
    def valid?
      ...
      return false if @price > 100000000
    ...
    def price=(price)
      ...
      if price > 100000000
        fail ArgumentError, 'invalid value for "price", must be smaller than or equal to 100000000.'
      end
