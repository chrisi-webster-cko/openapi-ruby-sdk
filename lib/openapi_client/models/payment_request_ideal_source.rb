...
module OpenapiClient
  # Ideal Source
  class PaymentRequestIdealSource < PaymentRequestSource
    ...
    # BIC (8 or 11-digits). In iDEAL-lingo this is also called issuerID
    attr_accessor :bic
    ...
    def self.openapi_all_of
      [
      :'PaymentRequestIdealSourceAllOf',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentRequestIdealSource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentRequestIdealSource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @description.to_s.length > 35
        invalid_properties.push('invalid value for "description", the character length must be smaller than or equal to 35.')
      end
    ...
    def valid?
      ...
      return false if @description.to_s.length > 35
    ...
    def description=(description)
      ...
      if description.to_s.length > 35
        fail ArgumentError, 'invalid value for "description", the character length must be smaller than or equal to 35.'
      end
