...
module OpenapiClient
  ...
  class Item
    ...
    attr_accessor :shipping_tracking_url
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'shipping_tracking_url')
        self.shipping_tracking_url = attributes[:'shipping_tracking_url']
      end
    end
    ...
    def hash
      [sku, name, description, image_url, price, quantity, shipping_cost, shipping_tracking_url].hash
    end
