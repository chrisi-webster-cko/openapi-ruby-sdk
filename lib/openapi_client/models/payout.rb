...
module OpenapiClient
  class Payout
    ...
    def hash
      [destination, amount, currency, payment_type, reference, description, capture, capture_on, customer, billing_descriptor, shipping, _3ds, previous_payment_id, risk, success_url, failure_url, payment_ip, recipient, processing, metadata].hash
    end
