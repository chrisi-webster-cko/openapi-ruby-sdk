...
module OpenapiClient
  # PagoFacil Source
  class PaymentRequestPagoFacilSource < PaymentRequestSource
    ...
    # Payer's country code. ISO 3166-1 alpha-2 code.
    ...
    def self.openapi_types
      {
        ...
        :'country' => :'String',
        :'description' => :'String',
        :'payer' => :'PaymentRequestPagoFacilSourceAllOfPayer'
      }
    end
    ...
    def self.openapi_all_of
      [
      :'PaymentRequestPagoFacilSourceAllOf',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentRequestPagoFacilSource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentRequestPagoFacilSource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      country_validator = EnumAttributeValidator.new('String', ["AR"])
    ...
    def country=(country)
      validator = EnumAttributeValidator.new('String', ["AR"])
    ...
    def hash
      [integration_type, country, description, payer].hash
    end
