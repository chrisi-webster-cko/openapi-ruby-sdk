...
module OpenapiClient
  ...
  class Model01PaymentResponseCardSource < PaymentResponseSource
    # The expiry month
    ...
    # The fast funds eligibility of the card. [Read more](https://docs.checkout.com/payment-actions/pay-out-to-a-card)
    attr_accessor :fast_funds
    ...
    def self.openapi_all_of
      [
      :'01PaymentResponseCardSourceAllOf',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::Model01PaymentResponseCardSource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Model01PaymentResponseCardSource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cvv_check')
        self.cvv_check = attributes[:'cvv_check']
      end
      ...
      if attributes.key?(:'fast_funds')
        self.fast_funds = attributes[:'fast_funds']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cvv_check == o.cvv_check &&
          payouts == o.payouts &&
          fast_funds == o.fast_funds &&
          payment_account_reference == o.payment_account_reference && super(o)
    end
    ...
    def hash
      [expiry_month, expiry_year, name, scheme, last4, fingerprint, bin, card_type, card_category, issuer, issuer_country, product_id, product_type, avs_check, cvv_check, payouts, fast_funds, payment_account_reference].hash
    end
