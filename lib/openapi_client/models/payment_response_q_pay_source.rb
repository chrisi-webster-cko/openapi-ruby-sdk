...
module OpenapiClient
  # QPay Source
  class PaymentResponseQPaySource < PaymentResponseSource
    ...
    def self.openapi_all_of
      [
      :'PaymentResponseQPaySourceAllOf',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentResponseQPaySource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentResponseQPaySource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'qpay_status')
        self.qpay_status = attributes[:'qpay_status']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          qpay_status == o.qpay_status &&
          status_message == o.status_message &&
          confirmation_id == o.confirmation_id && super(o)
    end
    ...
    def hash
      [description, qpay_status, status_message, confirmation_id].hash
    end
