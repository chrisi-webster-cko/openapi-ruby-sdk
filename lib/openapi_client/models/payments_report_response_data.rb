...
module OpenapiClient
  class PaymentsReportResponseData
    # The unique payment identifier. This was previously called `transaction_id`
    attr_accessor :id

    # The currency of the payment when processed by the cardholder
    attr_accessor :processing_currency
    ...
    # The name of the channel from which the payment was initiated
    attr_accessor :channel_name

    # An optional identifier used for tracking payments. This was previously called `track_id`
    ...
    # An optional, user-defined identifier for the business
    attr_accessor :mid
    ...
    def self.openapi_types
      {
        ...
        :'mid' => :'String',
        :'actions' => :'Array<PaymentsReportResponseActions>',
        :'_links' => :'PaymentsReportResponseLinks'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentsReportResponseData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentsReportResponseData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'processing_currency')
        self.processing_currency = attributes[:'processing_currency']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          processing_currency == o.processing_currency &&
    ...
    def hash
      [id, processing_currency, payout_currency, requested_on, channel_name, reference, payment_method, card_type, card_category, issuer_country, merchant_country, mid, actions, _links].hash
    end
