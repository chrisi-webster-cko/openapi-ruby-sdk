...
module OpenapiClient
  ...
  class PaymentRequestBenefitPaySource < PaymentRequestSource
    ...
    def self.openapi_all_of
      [
      :'PaymentRequestBenefitPaySourceAllOf',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentRequestBenefitPaySource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentRequestBenefitPaySource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      integration_type_validator = EnumAttributeValidator.new('String', ["web", "mobile"])
    ...
    def integration_type=(integration_type)
      validator = EnumAttributeValidator.new('String', ["web", "mobile"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          integration_type == o.integration_type && super(o)
    end
