...
module OpenapiClient
  ...
  class PaymentResponseMultibancoSource < PaymentResponseSource
    ...
    def self.openapi_all_of
      [
      :'PaymentResponseMultibancoSourceAllOf',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentResponseMultibancoSource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentResponseMultibancoSource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'service_supplier_id')
        self.service_supplier_id = attributes[:'service_supplier_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_supplier_id == o.service_supplier_id && super(o)
    end
    ...
    def hash
      [payment_reference, service_supplier_id].hash
    end
