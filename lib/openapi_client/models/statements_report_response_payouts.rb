...
module OpenapiClient
  class StatementsReportResponsePayouts
    ...
    # Identifies the associated payment
    attr_accessor :id
    ...
    def self.attribute_map
      {
        ...
        :'current_period_amount' => :'current_period_amount',
    ...
    def self.openapi_types
      {
        ...
        :'status' => :'String',
        :'payout__fee' => :'String',
        :'_links' => :'StatementsReportResponseLinks'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::StatementsReportResponsePayouts` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::StatementsReportResponsePayouts`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'carried_forward_amount')
        self.carried_forward_amount = attributes[:'carried_forward_amount']
      end

      if attributes.key?(:'current_period_amount')
        self.current_period_amount = attributes[:'current_period_amount']
      end
      ...
      if attributes.key?(:'payout__fee')
        self.payout__fee = attributes[:'payout__fee']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          currency == o.currency &&
          carried_forward_amount == o.carried_forward_amount &&
          current_period_amount == o.current_period_amount &&
    ...
    def hash
      [currency, carried_forward_amount, current_period_amount, net_amount, date, period_start, period_end, id, status, payout__fee, _links].hash
    end
