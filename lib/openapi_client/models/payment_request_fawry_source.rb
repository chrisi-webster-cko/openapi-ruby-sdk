...
module OpenapiClient
  # Fawry Source
  class PaymentRequestFawrySource < PaymentRequestSource
    # The payment description.
    attr_accessor :description

    # The customer's id within merchant's system.
    ...
    attr_accessor :customer_mobile

    # The date on which the payment expires.
    ...
    def self.openapi_types
      {
        ...
        :'expires_on' => :'String',
        :'products' => :'Array<PaymentRequestFawrySourceAllOfProducts>'
      }
    end
    ...
    def self.openapi_all_of
      [
      :'PaymentRequestFawrySourceAllOf',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentRequestFawrySource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentRequestFawrySource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'customer_mobile')
        self.customer_mobile = attributes[:'customer_mobile']
      end
    ...
    def list_invalid_properties
      ...
      if @description.to_s.length > 265
        invalid_properties.push('invalid value for "description", the character length must be smaller than or equal to 265.')
      end
      ...
      if @customer_mobile.nil?
        invalid_properties.push('invalid value for "customer_mobile", customer_mobile cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @description.to_s.length > 265
      return false if @customer_email.nil?
      return false if @customer_mobile.nil?
    ...
    def description=(description)
      ...
      if description.to_s.length > 265
        fail ArgumentError, 'invalid value for "description", the character length must be smaller than or equal to 265.'
      end
    ...
    def hash
      [description, customer_profile_id, customer_email, customer_mobile, expires_on, products].hash
    end
