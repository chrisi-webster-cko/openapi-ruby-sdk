...
module OpenapiClient
  # P24 Source
  class PaymentResponseP24Source < PaymentResponseSource
    # P24 generated payment descriptor, which will contain requested billing descriptor or merchant's default descriptor  (subject to truncation).
    attr_accessor :p24_descriptor

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'p24_descriptor' => :'p24_descriptor'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentResponseP24Source` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentResponseP24Source`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'p24_descriptor')
        self.p24_descriptor = attributes[:'p24_descriptor']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          p24_descriptor == o.p24_descriptor && super(o)
    end
