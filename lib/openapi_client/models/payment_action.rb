  ...
  class PaymentAction
    ...
    def self.openapi_types
      {
        ...
        :'reference' => :'String',
        :'processing' => :'PaymentActionProcessing',
        :'metadata' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentAction` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentAction`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["Authorization", "Card Verification", "Void", "Capture", "Refund", "Payout"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["Authorization", "Card Verification", "Void", "Capture", "Refund", "Payout"])
    ...
    def hash
      [id, type, processed_on, amount, approved, auth_code, response_code, response_summary, reference, processing, metadata].hash
    end
