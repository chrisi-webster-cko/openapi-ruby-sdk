...
module OpenapiClient
  # Sofort Source
  class PaymentResponseSofortSource < PaymentResponseSource
    # IBAN of a payer, available when a payment is authorised.
    attr_accessor :iban

    # BIC of a payer, available when a payment is authorised.
    attr_accessor :bic

    # The name of a payer, available when a payment is authorised.
    ...
    def self.openapi_all_of
      [
      :'PaymentResponseSofortSourceAllOf',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentResponseSofortSource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentResponseSofortSource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(o)
      ...
      self.class == o.class &&
          iban == o.iban &&
          bic == o.bic &&
          account_holder_name == o.account_holder_name && super(o)
    end
    ...
    def hash
      [iban, bic, account_holder_name].hash
    end
