...
module OpenapiClient
  # BenefitPay Source
  class PaymentResponseBenefitPaySource < PaymentResponseSource
    # Unique transaction reference number from BenefitPay
    attr_accessor :reference_number

    # String for generating the QR code to be scanned
    attr_accessor :qr_data

    # Reason for error with payment
    attr_accessor :failure_reason

    # Error code returned from BenefitPay.  For further detail, the full code meaning has to be requested directly from BenefitPay,  as CKO does not have access to this. 
    attr_accessor :error_code

    # Error description returned from BenefitPay
    ...
    def self.openapi_all_of
      [
      :'PaymentResponseBenefitPaySourceAllOf',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentResponseBenefitPaySource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentResponseBenefitPaySource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'qr_data')
        self.qr_data = attributes[:'qr_data']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          error_description == o.error_description && super(o)
    end
    ...
    def hash
      [reference_number, qr_data, failure_reason, error_code, error_description].hash
    end
