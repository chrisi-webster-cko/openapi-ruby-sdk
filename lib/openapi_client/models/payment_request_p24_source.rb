...
module OpenapiClient
  # P24 Source
  class PaymentRequestP24Source < PaymentRequestSource
    ...
    # RFC compliant email address of the account holder.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentRequestP24Source` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentRequestP24Source`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'account_holder_email')
        self.account_holder_email = attributes[:'account_holder_email']
      end
    ...
    def list_invalid_properties
      ...
      if @account_holder_email.nil?
        invalid_properties.push('invalid value for "account_holder_email", account_holder_email cannot be nil.')
      end

      if @account_holder_email.to_s.length > 254
        invalid_properties.push('invalid value for "account_holder_email", the character length must be smaller than or equal to 254.')
      end
    ...
    def valid?
      ...
      payment_country_validator = EnumAttributeValidator.new('String', ["PL"])
      ...
      return false if @account_holder_email.nil?
      return false if @account_holder_email.to_s.length > 254
    ...
    def payment_country=(payment_country)
      validator = EnumAttributeValidator.new('String', ["PL"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] account_holder_email Value to be assigned
    def account_holder_email=(account_holder_email)
      if account_holder_email.nil?
        fail ArgumentError, 'account_holder_email cannot be nil'
      end

      if account_holder_email.to_s.length > 254
        fail ArgumentError, 'invalid value for "account_holder_email", the character length must be smaller than or equal to 254.'
      end
    ...
    def hash
      [payment_country, account_holder_name, account_holder_email, billing_descriptor].hash
    end
