...
module OpenapiClient
  class FilePurpose
    DISPUTE_EVIDENCE = "dispute_evidence".freeze
    ...
    def build_from_hash(value)
      constantValues = FilePurpose.constants.select { |c| FilePurpose::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #FilePurpose" if constantValues.empty?
      value
    end
  end
end
