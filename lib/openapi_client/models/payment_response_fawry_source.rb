...
module OpenapiClient
  # Fawry Source
  class PaymentResponseFawrySource < PaymentResponseSource
    # Payment description
    ...
    def self.openapi_all_of
      [
      :'PaymentResponseFawrySourceAllOf',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentResponseFawrySource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentResponseFawrySource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @description.to_s.length > 65534
        invalid_properties.push('invalid value for "description", the character length must be smaller than or equal to 65534.')
      end
    ...
    def valid?
      ...
      return false if @description.to_s.length > 65534
      true && super
    end
    ...
    def description=(description)
      ...
      if description.to_s.length > 65534
        fail ArgumentError, 'invalid value for "description", the character length must be smaller than or equal to 65534.'
      end
    ...
    def hash
      [description, reference_number].hash
    end
