...
module OpenapiClient
  ...
  class 02GooglePayTokenRequestAllOfTokenData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::02GooglePayTokenRequestAllOfTokenData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::02GooglePayTokenRequestAllOfTokenData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'signed_message')
        self.signed_message = attributes[:'signed_message']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          signed_message == o.signed_message
    end
    ...
    def hash
      [signature, protocol_version, signed_message].hash
    end
