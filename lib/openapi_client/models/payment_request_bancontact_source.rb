...
module OpenapiClient
  # Bancontact Source
  class PaymentRequestBancontactSource < PaymentRequestSource
    ...
    # The 2-letter ISO language code that should be preferred when presenting payment pages to the consumer.
    ...
    def self.openapi_all_of
      [
      :'PaymentRequestBancontactSourceAllOf',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentRequestBancontactSource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentRequestBancontactSource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      payment_country_validator = EnumAttributeValidator.new('String', ["BE"])
      ...
      language_validator = EnumAttributeValidator.new('String', ["fr", "nl", "de", "en"])
    ...
    def payment_country=(payment_country)
      validator = EnumAttributeValidator.new('String', ["BE"])
    ...
    def language=(language)
      validator = EnumAttributeValidator.new('String', ["fr", "nl", "de", "en"])
    ...
    def hash
      [payment_country, account_holder_name, billing_descriptor, language].hash
    end
