...
module OpenapiClient
  # Processing information required for <a href=\"https://docs.checkout.com/payment-methods/cards/dlocal\" target=\"_blank\">dLocal payments</a>.
  class PaymentRequestProcessingDlocal
    # The two-letter ISO code of the cardholder's country.
    ...
    def self.openapi_types
      {
        :'country' => :'String',
        :'payer' => :'PaymentRequestProcessingDlocalPayer',
        :'installments' => :'PaymentRequestProcessingDlocalInstallments'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentRequestProcessingDlocal` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentRequestProcessingDlocal`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [country, payer, installments].hash
    end
