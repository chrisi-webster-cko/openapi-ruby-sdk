...
module OpenapiClient
  class PaymentsReportResponseBreakdown
    # Describes an amount or fee associated with an action. For example, a gateway fee, capture fee and capture amount would all be associated with the capture action
    attr_accessor :type
    ...
    attr_accessor :processing_currency_amount
    ...
    def self.attribute_map
      {
        :'type' => :'type',
        :'date' => :'date',
        :'processing_currency_amount' => :'processing_currency_amount',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PaymentsReportResponseBreakdown` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PaymentsReportResponseBreakdown`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'processing_currency_amount')
        self.processing_currency_amount = attributes[:'processing_currency_amount']
      end

      if attributes.key?(:'payout_currency_amount')
        self.payout_currency_amount = attributes[:'payout_currency_amount']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          type == o.type &&
          date == o.date &&
          processing_currency_amount == o.processing_currency_amount &&
          payout_currency_amount == o.payout_currency_amount
    end
    ...
    def hash
      [type, date, processing_currency_amount, payout_currency_amount].hash
    end
